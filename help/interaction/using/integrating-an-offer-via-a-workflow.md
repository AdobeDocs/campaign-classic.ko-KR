...
1. 게재 개요 활동에서 사용할 개요를 지정합니다.
   ...
   게재 아웃라인 지정에 대한 자세한 내용은 [캠페인 - MRM](../../campaign/using/marketing-campaign-deliveries.md#associating-and-structuring-resources-linked-via-a-delivery-outline) 안내서를 참조하십시오.
...
>[!NOTE]
>
>데이터 보강 활동에 대한 자세한 내용은 [워크플로우 안내서](../../workflow/using/enrichment.md)의 전용 설명서를 참조하십시오.
...
1. 그런 다음 선택한 채널에 해당하는 게재 활동을 구성합니다. 자세한 내용은 [게재](../../interaction/using/integrating-an-offer-via-the-wizard.md#inserting-an-offer-proposition-into-a-delivery) 섹션에 오퍼 제안 삽입 을 참조하십시오.
...
1. 쿼리 뒤에, 게재 활동 전에 배치된 데이터 보강 활동에서 오퍼 엔진에 대한 호출을 만듭니다. [오퍼 지정 또는 오퍼 엔진 호출](../../interaction/using/integrating-an-offer-via-a-workflow.md#specifying-an-offer-or-a-call-to-the-offer-engine) 섹션을 참조하십시오.
