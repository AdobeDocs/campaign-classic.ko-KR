...
1. 게재 개요 활동에서 사용할 개요를 지정합니다.
   ...
   게재 개요 지정에 대한 자세한 내용은 [Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-assets#delivery-outlines.html){target="_blank"}를 참조하세요.
