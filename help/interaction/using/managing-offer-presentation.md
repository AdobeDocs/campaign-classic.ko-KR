...
다음 **[!UICONTROL Targeting dimension]** 수신자 테이블과 일치합니다(기본적으로: `nms:recipients`) 오퍼를 받을 사람입니다. 다음 **[!UICONTROL Storage dimension]** 은 타겟팅 차원에 연결된 제안 내역을 포함하는 테이블과 일치합니다(기본적으로: `nms:propositionRcp`).
