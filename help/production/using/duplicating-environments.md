...
### 5단계 - 대상 환경(dev) {#step-5---cauterize-the-target-environment--dev-} 지우기
...
### 6단계 - 소작화 확인 {#step-6---check-cauterization}
...
### 8단계 - 옵션 및 외부 계정을 대상 환경(개발)으로 가져오기 {#step-8---import-options-and-external-accounts-into-the-target-environment--dev-}
