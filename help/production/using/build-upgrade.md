...
빌드 업그레이드는 신중하게 수행되어야 하며, 그 영향은 사전에 충분히 고려되어야 하고 높은 수준의 규율로 절차가 완료되어야 한다. 업그레이드를 성공적으로 수행하려면 전문가 사용자만 아래에 설명된 단계를 수행해야 합니다. 또한 업그레이드를 시작하기 전에 [고객 지원 Adobe](https://helpx.adobe.com/kr/enterprise/admin-guide.html/enterprise/using/support-for-experience-cloud.ug.html)에 연락하는 것이 좋습니다.
...
1. **Setup.exe** 파일을 실행합니다. 이 파일을 다운로드하려면 [다운로드 센터](https://experience.adobe.com/#/downloads/content/software-distribution/ko/campaign.html)에 액세스하세요.
...
1. Publish 메시지 센터 템플릿을 사용하여 서버와 메시지 센터 인스턴스 간의 인터페이스가 작동하는지 확인합니다.
...
1. 중간 소싱 서버의 업그레이드를 조정하려면 [고객 지원 Adobe](https://helpx.adobe.com/kr/enterprise/admin-guide.html/enterprise/using/support-for-experience-cloud.ug.html)에 문의하십시오.
...
1. [다운로드 센터](https://experience.adobe.com/#/downloads/content/software-distribution/ko/campaign.html) 또는 업그레이드되지 않은 다른 제품 설치를 통해 원본 버전을 검색합니다.
1. [다운로드 센터](https://experience.adobe.com/#/downloads/content/software-distribution/ko/campaign.html) 또는 고객이 설치한 파일을 통해 새 버전을 검색합니다.
