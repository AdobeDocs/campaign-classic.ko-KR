...
<tr> 
<td>웹 서버가 응답합니까?</td> 
<td>웹 브라우저 <b>http(s):// &lt;urlserver&gt;</b>을(를) 사용하여 Adobe Campaign 서버 액세스 URL에 연결합니다. 응답하지 않으면 웹 서버가 시스템에서 중지됩니다. 서비스를 다시 시작하려면 호스트 회사의 시스템 관리자에게 문의하십시오.</td>
</tr>
<tr> 
...
<td>전체 Adobe Campaign 애플리케이션을 다시 시작해야 합니다. 이렇게 하려면 <b>nlserver watchdog -svc -noconsole</b> 명령을 사용합니다.</td>
</tr>
</tbody> 
</table>
