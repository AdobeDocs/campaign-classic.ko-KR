...
이러한 보고서의 내용에 대한 자세한 내용은 [이 섹션을 참조하십시오](../../reporting/using/delivery-reports.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 원인 및 도메인별로 바운스 및 비산출물<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
  <tr> 
   <td> 추적 표시기(deliveryFeedback)<br /> </td> 
   <td> 수신자 동작 추적을 위한 주요 지표의 요약<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
  <tr> 
   <td> 추적 표시기(mobileAppDeliveryFeedback)<br /> </td> 
   <td> 모바일 애플리케이션에 대한 배달의 추적 표시기.<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
  <tr> 
   <td> 브라우저(browserStatistics)<br /> </td> 
   <td> 메시지를 클릭한 수신자가 사용하는 브라우저에 대한 통계<br /> </td> 
   <td> xtk:none<br /> </td> 
  </tr> 
  <tr> 
   <td> 소셜 네트워크에 공유(전달)<br /> </td> 
   <td> 활동 및 메일 열기 통계 공유<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
  <tr> 
   <td> 핫 클릭(선택)<br /> </td> 
   <td> 메시지 및 겹쳐진 클릭률을 표시합니다.<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
  <tr> 
   <td> 가설 보고서(delivery가설)<br /> </td> 
   <td> 전달 가설에 대한 측정 요약이 표시됩니다.<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 배달 지표의 요약:대상, 제외 및 메시지가 전송되었습니다.<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 메시지를 클릭한 수신자가 사용하는 운영 체제에 대한 통계<br /> </td> 
   <td> xtk:none<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 가장 활성화된 URL 및 연결된 클릭 스트림입니다.<br /> </td> 
   <td> nms:배달<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
이러한 보고서의 내용에 대한 자세한 내용은 [이 섹션을 참조하십시오](../../campaign/using/designing-marketing-campaigns.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 원가 라인에 대한 설명적 분석은 MRM에 따라 다릅니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 대부분의 반응형 URL 및 관련 클릭 스트림은 캠페인에 따라 다릅니다.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 잠재 고객 확보를 가능하게 한 웹 애플리케이션은 무엇입니까? 소셜 마케팅 Add-on에 따라 다릅니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 구독 분류(mobileAppDistribution)<br /> </td> 
   <td> 모바일 애플리케이션당 활성 구독 분류는 모바일 앱 채널 Add-On에 따라 달라집니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> 구독 추적(구독 진행)<br /> </td> 
   <td> 정보 서비스에 대한 구독 발전<br /> </td> 
  </tr> 
  <tr> 
   <td> 재활동 비율(socialResponsiveRate)<br /> </td> 
   <td> 최근 배달의 재활동 비율은 얼마입니까? 소셜 마케팅 Add-on에 따라 다릅니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 약정 수준별로 예산 비용 진화<br /> </td> 
   <td> nms:예산<br /> </td> 
  </tr> 
  <tr> 
   <td> 예산의 누적 진화(budgetCumulativeEvolution)<br /> </td> 
   <td> 누적된 예산 비용의<br /> 진화는 각급별로 분류된다. </td> 
   <td> nms:예산<br /> </td> 
  </tr> 
  <tr> 
   <td> 비용 라인 탐색(budgetExplorer예산)<br /> </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> 시뮬레이션 제외 세부 사항(dlpSimuLossDetail)<br /> </td> 
   <td> 모든 제외 사유에 대한 세부 표.<br /> </td> 
  </tr> 
  <tr> 
   <td> 등급별 오퍼 분류(offerSimulationRanking)<br /> </td> 
   <td> 등급별로 시뮬레이션에서 오퍼 분류<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> 시뮬레이션에 따른 제외 요약(dlvSimuLossSimu)<br /> </td> 
...
이러한 보고서의 내용에 대한 자세한 내용은 [이 섹션을 참조하십시오](../../web/using/about-web-applications.md).
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 오퍼 분석은 상호 작용 추가 기능에 따라 달라집니다.<br /> </td> 
   <td> nms:오퍼<br /> </td> 
  </tr> 
  <tr> 
