...
이러한 보고서의 내용에 대한 자세한 내용은 [이 섹션](../../reporting/using/delivery-reports.md).
...
이러한 보고서의 내용에 대한 자세한 내용은 [이 섹션](../../campaign/using/designing-marketing-campaigns.md).
...
이러한 보고서의 내용에 대한 자세한 내용은 [이 섹션](../../web/using/about-web-applications.md).
