...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 클릭<br /> </td> 
   <td> @clicks<br /> </td> 
   <td> URL 유형이 "Email click"과 동일한 모든 @totalClicks의 합계.<br /> </td> 
   <td> sum(Iif([url/@type]=1, @totalClicks, 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 트랜잭션<br /> </td> 
   <td> @transactions<br /> </td> 
   <td> URL 유형이 "Transaction"인 모든 @totalClicks의 합계.<br /> </td> 
   <td> sum(Iif([url/@type]=5, @totalClicks, 0)<br /> </td> 
  </tr> 
 </tbody> 
</table>

이 보고서는 **[!UICONTROL Consolidated tracking]** 테이블을 기반으로 합니다(nms:trackingStats). 이 집계 테이블은 보고서를 **[!UICONTROL Recipient tracking logs]** 테이블 대신 표시할 때 성능상의 이유로 사용되며 실시간으로 계산되지 않습니다. 추적 로그가 검색되면 몇 분 후에 테이블이 생성됩니다. 표시기가 최신 상태이면 결과는 **추적 표시기** 보고서의 표시기와 동일합니다. 이 @totalclicks 지표는 5분 동안의 총 클릭 수를 나타냅니다.

## 게재 불가 및 이탈 {#non-deliverables-and-bounces-1}

**오류 유형별 분류**

이 보고서는 **[!UICONTROL Delivery and tracking statistics]** 테이블을 기반으로 합니다(nms:deliveryLogStats).
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 상태가 "Ready", "Sent" 또는 "Failed"인 메시지의 합계입니다.<br /> </td> 
  ...
  <tr> 
   <td> 계정이 비활성화됨<br /> </td> 
   <td> @disabled<br /> </td> 
   <td> 상태가 "실패"이고 "계정이 비활성화됨"인 이유가 있는 모든 메시지의 수입니다.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 배달을 한 번 이상 클릭한 이 브라우저의 대상 받는 사람의 총 수입니다.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 사용 속도<br /> </td> 
   <td> @visitors<br /> </td> 
   <td> 이 브라우저를 사용하는 일별 방문자 수의 백분율입니다.<br /> </td> 
   <td> percent(sum(@visitors),max(@visitorsOfTheDay)<br /> </td> 
  </tr> 
  <tr> 
   <td> 전역 비율<br /> </td> 
   <td> -<br /> </td> 
   <td> 이 버전의 방문자의 백분율과 모든 브라우저를 사용하는 총 방문자 수와 비교한 것입니다.<br /> </td> 
   <td> percent(@totalVisitors, @globalVisitors<br />) </td> 
  </tr> 
  <tr> 
   <td> 상대 가중치<br /> </td> 
   <td> -<br /> </td> 
   <td> 이 버전에 대한 방문자의 백분율과 이 브라우저를 사용하는 총 방문자 수를 비교한 것입니다.<br /> </td> 
   <td> percent(@totalVisitors, sum(@totalVisitors) <br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 이메일<br /> </td> 
   <td> @email<br /> </td> 
   <td> URL 카테고리가 "email"과 같은 모든 @totalClicks의 합계.<br /> </td> 
   <td> Sum(iIf([url/@category]='email',@totalClicks,0)<br /> </td> 
  </tr> 
  <tr> 
   <td> Facebook<br /> </td> 
   <td> @facebook<br /> </td> 
   <td> URL 카테고리가 "facebook"인 모든 @totalClicks의 합계.<br /> </td> 
   <td> Sum(iIf([url/@category]='facebook',@totalClicks,0)<br /> </td> 
  </tr> 
  <tr> 
   <td> Twitter<br /> </td> 
   <td> @twitter<br /> </td> 
   <td> URL 카테고리가 "twitter"인 모든 @totalClicks의 합계.<br /> </td> 
   <td> Sum(iIf([url/@category]='twitter',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 맛있는<br /> </td> 
   <td> @delicious<br /> </td> 
   <td> URL 카테고리가 "delicious"인 모든 @totalClicks의 합계.<br /> </td> 
  ...
  <tr> 
   <td> Linkedin<br /> </td> 
   <td> @linkedin<br /> </td> 
   <td> URL 카테고리가 "linkedin"과 같은 모든 @totalClicks의 합계.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 공유율<br /> </td> 
   <td> @rate<br /> </td> 
   <td> 이 네트워크의 공유 수와 배달할 메시지 수를 비교한 것입니다.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 공유<br /> </td> 
   <td> @shared<br /> </td> 
   <td> 'email' , 'facebook' , 'twitter' , '맛있는' , 'digg' , 'google' , 'linkedin'<br /> "email", "facebook", "twitter", "맛있는", "digg", "google" 또는 "linkedin"과 같은 URL 카테고리가 있는 모든 @totalClicks 개수입니다.<br /> </td> 
   <td> count (Iif([url/@category] IN (전자 메일' , 'facebook' , 'twitter' , '맛있는' , 'dig' , 'google' , 'linkedin'), @totalClicks, 0))<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 모든 게재에 대한 운영 체제당 게재 링크에 대한 총 클릭 수의 일별 평균입니다.<br /> </td> 
   <td> Sum(@pages)<br /> </td> 
  </tr> 
  <tr> 
   <td> 사용 속도<br /> </td> 
   <td> -<br /> </td> 
   <td> 운영 체제당 방문자 수 분류와 총 방문자 수 비교.<br /> </td> 
   <td> percent(@totalVisitors, sum(@totalVisitors)<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 사용 속도<br /> </td> 
   <td> @visitors<br /> </td> 
   <td> 이 운영 체제에서 일별 방문자 수의 백분율로, 가장 많은 방문 횟수가 있는 날에 측정된 방문자 수와 비교한 것입니다.<br /> </td> 
   <td> percent(sum(@visitors), max(@visitorsOfTheDay)<br /> </td> 
  </tr> 
  <tr> 
   <td> 전역 비율<br /> </td> 
   <td> -<br /> </td> 
   <td> 버전당 방문자의 백분율과 모든 운영 체제의 총 방문자 수 비교.<br /> </td> 
   <td> percent(@totalVisitors, @globalVisitors<br />) </td> 
  </tr> 
  <tr> 
   <td> 상대 비율<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 이전 날짜의 구독 취소 수(작업 = 0)입니다.<br /> </td> 
   <td> sum(iif(@action = 0 및 @date &gt; addDays(getDate(), (-1)), 1, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Evolution<br /> </td> 
   <td> -<br /> </td> 
   <td> 구독 수에서 구독 수를 뺀 것입니다. 이 비율은 총 구독자 수에 따라 계산됩니다.<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 게재할 메시지<br /> </td> 
   <td> @toDeliver<br /> </td> 
   <td> 대상 분석 후 broadLogs 수의 개수입니다.<br /> </td> 
  ...
  <tr> 
   <td> 모집단에서 개별적인 열기 수가<br />에 도달했습니다. </td> 
   <td> @estimatedRecipientOpen<br /> </td> 
   <td> html 형식의 전자 메일에 대한 개별적인 열기 수를 기반으로 모든 전자 메일에 대한 개별 열기 수를 계산합니다.<br /> </td> 
   <td> Iif([@toDeliver] - [@text]) = 0, 0, round(toDouble(@recipientOpen) * [@toDeliver] / ([@toDeliver] - [@text]), 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 모집단에 대한 열기 합계<br />에 도달했습니다. </td> 
   <td> @estimatedTotalRecipientOpen<br /> </td> 
   <td> html 형식의 총 이메일 열기 수를 기반으로 모든 전자 메일에 대한 총 열기 수를 계산합니다.<br /> </td> 
   <td> Iif([@toDeliver] - [@text]) = 0, 0, round(toDouble(@totalRecipientOpen) * [@toDeliver] / ([@toDeliver] - [@text]), 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 구독 취소 링크<br />에 대한 클릭 </td> 
   <td> @optOut<br /> </td> 
   <td> URL 카테고리가 "옵트아웃"과 같은 모든 @ids 개수입니다.<br /> </td> 
   <td> count(Iif([url/@type]=3, @id, 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 미러 페이지<br /> 링크를 클릭합니다. </td> 
   <td> @mirrorPage<br /> </td> 
   <td> URL 카테고리가 "Mirror page"와 같은 모든 @ids 개수입니다.<br /> </td> 
   <td> count(Iif([url/@type]=6, @id, 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 전달<br /> 추정 </td> 
   <td> @forward<br /> </td> 
   <td> 개별 사용자 수와 전자 메일을 한 번 이상 클릭한 개별 수신자 수 간의 차이입니다.<br /> </td> 
   <td> @personClick - @recipientClick<br /> </td> 
  </tr> 
  <tr> 
   <td> Sends<br /> </td> 
   <td> @successWithoutSeeds<br /> </td> 
   <td> "시드 주소" 필드가 "아니요"이고 상태가 "수신자에 의해 고려됨" 또는 "전송됨" 또는 "모바일에서 수신됨"과 같은 메시지의 개수입니다.<br /> </td> 
   <td> sum([indicators/@success])<br /> </td> 
  </tr> 
  <tr> 
   <td> 컴플레인<br /> </td> 
   <td> @complaints<br /> </td> 
   <td> 상태가 "Failed"이고 "Address on State"인 원인차단 목록의 메시지 수입니다.<br /> </td> 
  ...
  <tr> 
   <td> 원시 반응성<br /> </td> 
   <td> -<br /> </td> 
   <td> 게재를 한 번 이상 클릭한 수신자 수의 백분율입니다.<br /> </td> 
   <td> percent(@recipientClick,@recipientOpen<br /> </td> 
  </tr> 
  <tr> 
   <td> 모집단에 대한 개별 클릭이<br />에 도달했습니다. </td> 
   <td> @personClick<br /> </td> 
   <td> URL 카테고리가 "Email click"과 같은 모든 @source-ids 개수입니다.<br /> </td> 
   <td> Countdistinct(Iif([url/@type]=1, @source-id, 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 누적 클릭 수<br /> </td> 
   <td> @totalRecipientClick<br /> </td> 
   <td> "Email click"과 같은 URL 카테고리가 있는 모든 @ids 개수입니다.<br /> </td> 
   <td> count(Iif([url/@type]=1, @id, 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 수신자가 <br /> 클릭 </td> 
   <td> @recipientClick<br /> </td> 
   <td> "Email click"과 같은 URL 유형을 사용하는 @broadLog-ids의 고유 개수입니다.<br /> </td> 
   <td> Countdistinct(Iif([url/@type]=1, @broadLog-id, 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 예상 반응성<br /> </td> 
   <td> -<br /> </td> 
   <td> 게재를 한 번 이상 클릭한 수신자 수의 비율입니다.<br /> </td> 
   <td> percent(@recipientClick, @estimatedRecipientOpen<br /> </td> 
  </tr> 
  <tr> 
   <td> 방문한 페이지<br /> </td> 
   <td> @totalWebPage<br /> </td> 
   <td> URL 유형이 "Web" 또는 "Transaction"인 모든 @ids 개수입니다.<br /> </td> 
   <td> count(Iif([url/@type]=4 또는 [url/@type]=5, @id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 트랜잭션<br /> </td> 
   <td> @transaction<br /> </td> 
   <td> URL 유형이 "Transaction"인 모든 @ids 개수입니다.<br /> </td> 
  ...
  <tr> 
   <td> 항목<br /> </td> 
   <td> @article<br /> </td> 
   <td> "Transaction"과 같은 URL 유형을 사용하는 webTrackingLog/@articles의 합계.<br /> </td> 
  ...
  <tr> 
   <td> 이메일<br /> </td> 
   <td> @email<br /> </td> 
   <td> "email"과 같은 URL 카테고리가 있는 모든 @totalClicks의 합계.<br /> </td> 
   <td> Sum(iIf([url/@category]='email',@totalClicks,0)<br /> </td> 
  </tr> 
  <tr> 
   <td> Facebook<br /> </td> 
  ...
  <tr> 
   <td> 맛있는<br /> </td> 
   <td> @delicious<br /> </td> 
   <td> URL 카테고리가 "맛있는" 모든 @totalClicks의 합계.<br /> </td> 
   <td> Sum(iIf([url/@category]='delicious',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Digg<br /> </td> 
...
이 보고서는 **[!UICONTROL Delivery]** 테이블을 기반으로 합니다(nms:delivery).
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 초기 채우기<br /> </td> 
   <td> @totalTarget<br /> </td> 
   <td> 게재에서 타겟팅한 총 받는 사람 수입니다.<br /> </td> 
   <td> sum([properties/@totalTarget])<br /> </td> 
  </tr> 
  <tr> 
...
이 보고서는 각 링크에 대한 클릭 비율(%)이 있는 메시지 콘텐츠(HTML 및/또는 텍스트)를 보여줍니다. 개인화 블록은 구독 취소 링크 및 미러 페이지 링크를 합한 총 클릭 수를 고려하지만 보고서에 표시되지 않습니다.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 클릭<br /> </td> 
   <td> @clicks<br /> </td> 
   <td> "Email click"과 같은 URL 유형을 가진 모든 @totalClicks의 합계.<br /> </td> 
   <td> sum(Iif([url/@type] = 1, @totalClicks, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 열기<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 소프트 바운스<br /> </td> 
   <td> @softBounce<br /> </td> 
   <td> 상태가 "실패"이고 "연결할 수 없음", "받은 편지함 가득 참", "잘못된 도메인", "사용할 수 없는 계정", "연결되지 않음" 또는 "거부됨"<br />인 모든 메시지의 합계입니다. </td> 
...
특정 지표에 대한 비동기화 또는 불일치가 발생하는 경우 Adobe Campaign 탐색기에서 해당 게재를 선택하고 마우스 오른쪽 단추를 클릭한 다음 **[!UICONTROL Action>Recompute delivery and tracking indicators]** 을(를) 선택합니다. **[!UICONTROL Next]** 을 클릭한 다음 **[!UICONTROL Finish]** 를 클릭합니다.
