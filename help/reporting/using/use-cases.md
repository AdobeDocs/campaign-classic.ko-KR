...
이 예제에서는 **Newsletters** 폴더에 포함된 게재의 대상 모집단을 살펴보려고 합니다.
...
표시할 데이터가 포함된 변수를 선택하려면 **[!UICONTROL Add...]** 링크를 클릭하십시오. 여기에서는 게재 수신자의 도시를 한 줄로 표시하려고 합니다.

![](assets/reporting_descriptive_quickstart_step_2.png)

열에는 회사당 구매 수가 표시됩니다. 이 예에서 금액은 **웹 구매** 필드에서 집계됩니다.

여기에서는 결과를 정의하여 표시를 명확하게 하려고 합니다. 이렇게 하려면 **[!UICONTROL Manual]** 바인딩 옵션을 선택하고 표시할 세그먼트의 계산 클래스를 설정합니다.
...
1. **[!UICONTROL Next]** 을 클릭하고 기본 **[!UICONTROL Simple count]** 통계를 그대로 둡니다.
1. 보고서를 표시하려면 **[!UICONTROL Next]** 을 클릭하십시오.
...
1. **[!UICONTROL Age]** 변수를 선택하고 해당 레이블을 입력합니다. 정수인지 여부를 지정한 다음 **[!UICONTROL Next]**&#x200B;을 클릭합니다.
...
1. 이 시점에서 **[!UICONTROL Existing analyses and reports]** 옵션을 선택하고 이전에 만든 보고서를 사용할 수 있습니다( [기존 보고서 다시 사용 및 분석](../../reporting/using/processing-a-report.md#re-using-existing-reports-and-analyses) 참조). 또는 새로운 설명 분석을 만들 수 있습니다. 이렇게 하려면 기본적으로 선택된 **[!UICONTROL New descriptive analysis from a template]** 옵션을 그대로 둡니다.
...
* **[!UICONTROL Keep the result of interim populations between two executions]** 옵션을 선택하여 워크플로우의 속성을 수정합니다. 워크플로우가 완료된 경우에도 선택한 전환의 분석을 시작할 수 있습니다.
...
1. 그런 다음 **[!UICONTROL General]** 탭을 클릭하여 통계 레이블과 해당 별칭의 이름을 변경합니다.
