...
소중한 Adobe Campaign Classic 고객으로서 최고의 경험과 가치를 제공하기 위해 최선을 다하고 있습니다. 수년에 걸쳐 Dell은 클라우드에서 고객을 호스팅할 수 있는 가치와 안정성을 실현했습니다.  [연간 업그레이드 이니셔티브](../../rn/using/rn-overview.md#yearly-upgrade)의 일부로, 더 우수하고 안정적인 서비스를 제공하기 위해 모든 고객을 Managed Services(AWS의 공용 클라우드) Adobe으로 전환하고 있습니다.
