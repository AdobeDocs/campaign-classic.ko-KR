...
v5에서 **sessiontoken** 매개 변수는 클라이언트측(개요 유형 화면, 링크 편집기 등의 목록)과 서버측(웹 응용 프로그램, 보고서, jsp, jssp 등)에서 모두 작동했습니다. v7에서는 서버측에서만 작동합니다. v5에서처럼 전체 기능으로 돌아가려면 이 매개 변수를 사용하여 링크를 수정하고 연결 페이지를 통해 전달해야 합니다.
...
* `<where>` 요소의 하위 요소인 새 `<node>` 요소: SELECT에서 &quot;하위 선택&quot;을 수행할 수 있습니다.
...
1. **[!UICONTROL Type of Environment]** 탭의 **[!UICONTROL General]** 필드에서 **[!UICONTROL Live]**&#x200B;을(를) 선택합니다.
