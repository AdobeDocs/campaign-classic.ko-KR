...
1. SQL 변경 내용을 삭제합니다.
1. 다음에 자세히 설명된 절차에 따라 사후 업그레이드를 수행합니다.  [Adobe Campaign 7으로 마이그레이션하기 위한 사전 요구 사항](../../migration/using/prerequisites-for-migration-to-adobe-campaign-7.md) 섹션을 참조하십시오.
   >[!NOTE]
   >
   >에 제시된 마이그레이션 단계를 반드시 따라야 합니다 [Adobe Campaign 7으로 마이그레이션하기 위한 사전 요구 사항](../../migration/using/prerequisites-for-migration-to-adobe-campaign-7.md) 섹션을 참조하십시오.
