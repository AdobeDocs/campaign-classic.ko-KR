...
* **외부 계정**
  ...
  **[!UICONTROL Administration > Platform > External accounts]**&#x200B;에서 다음 외부 SFTP 계정이 올바르게 구성되었는지 확인하십시오. 컨설턴트가 Adobe Experience Cloud에서 SFTP 서버를 구성해야 합니다.
...
Experience Cloud Audience를 통해 대상을 공유하거나 대상을 가져올 때 일부 데이터가 누락될 수 있습니다. ID(&#39;방문자 ID&#39; 또는 &#39;선언된 ID&#39;)가 프로필 차원과 조정될 수 있는 레코드만 전송됩니다. Adobe Campaign에서 인식하지 못하는 세그먼트의 ID는 가져오지 않습니다.
