...
1. 수신자의 이름이 Campaign Standard에서 업데이트되었는지 확인합니다. Campaign Standard에서 프로필을 찾을 수 있는 위치를 알아보려면 [탐색 기본 사항](https://experienceleague.adobe.com/docs/campaign-standard/using/getting-started/discovering-the-interface/interface-description.html?lang=ko).
...
1. Campaign Standard으로 이동하여 수신자에 대한 프로필 세부 사항을 엽니다. 다음 옆에 확인란이 표시되는지 확인합니다. **[!UICONTROL No longer contact (by any channel)]**. Campaign Standard에서 프로필을 찾을 수 있는 위치를 알아보려면 [탐색 기본 사항](https://experienceleague.adobe.com/docs/campaign-standard/using/getting-started/discovering-the-interface/interface-description.html?lang=ko).
