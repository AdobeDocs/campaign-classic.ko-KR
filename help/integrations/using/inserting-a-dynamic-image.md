...
* **[!UICONTROL Default image]**&#x200B;의 URL: 조건이 충족되지 않을 때 표시되는 이미지입니다. Assets 라이브러리에서 이미지를 선택할 수도 있습니다.
* **[!UICONTROL Target location]**: 동적 오퍼의 위치 이름을 입력하십시오. Target 활동에서 이 위치를 선택해야 합니다.
...
이제 Adobe Campaign에서 이메일을 미리 보고 다른 수신자에서 해당 렌더링을 테스트할 수 있습니다. 생성된 다양한 경험에 따라 이미지가 변경되는 것을 볼 수 있습니다. 전자 메일 만들기에 대한 자세한 내용은 이 [페이지](../../delivery/using/defining-the-email-content.md)를 참조하세요.
