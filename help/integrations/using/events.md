...
검색된 마지막 이벤트의 &#39;offset&#39;이 데이터베이스에 저장됩니다. 따라서 프로세스가 중지되면 마지막 메시지에서 다시 시작됩니다. 이 데이터는 기본 제공 스키마 xtk:pipelineOffset에 저장됩니다.
...
>[!NOTE]
>
>파이프라인 이벤트 노드는 기본 제공되지 않으므로 추가되어야 하며, Campaign에서 관련 양식을 만들어야 합니다. 이러한 작업은 전문가 사용자로만 제한됩니다. 자세한 내용은 [양식 편집](../../configuration/using/editing-forms.md)을 참조하세요.
