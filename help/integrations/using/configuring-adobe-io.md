...
* 조직에 대한 **개발자 액세스**. 조직의 시스템 관리자는 트리거와 연결된 Adobe Analytics 제품의 **제품 프로필에 대한 개발자 액세스 권한을 제공하려면**&#x200B;단일 제품 프로필에 개발자 추가[&#x200B; 절차(이 페이지의 &#x200B;](https://helpx.adobe.com/kr/enterprise/using/manage-developers.html)설명`Analytics - {tenantID}`)를 따라야 합니다.
