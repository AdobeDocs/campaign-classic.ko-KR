...
[토론 ](../../mrm/using/discussion-forums.md) 포럼이 Adobe Campaign에서 작동하는 방식을 설명합니다.
...
* 리소스가 마케팅 리소스 만들기 작업을 통해 관리되는 경우 작업에서 **[!UICONTROL Publish the marketing resource]** 상자를 선택하면 작업이 **[!UICONTROL Finished]**&#x200B;로 설정될 때 실행됩니다( [마케팅 리소스 생성 작업](../../mrm/using/creating-and-managing-tasks.md#marketing-resource-creation-task) 참조)
