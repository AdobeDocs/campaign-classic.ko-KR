...
1. 예상 잠정 비용
   ...
   이 금액은 수동으로 입력되며 여러 비용 범주로 분류할 수 있습니다. 비용을 줄이려면 **[!UICONTROL Breakdown...]** 링크를 클릭한 다음 **[!UICONTROL Add]** 버튼을 클릭하여 새 금액을 정의합니다.
...
### 계산 및 충전 {#calculation-and-charging}

비용은 비용 구조를 통해 계산되며 관련 캠페인, 게재 또는 작업에서 선택한 예산에 청구됩니다.

예산 승인을 통해 캠페인에 커밋된 금액에 대해 검사할 수 있습니다. 다른 승인을 설정하기 위해 캠페인에 추가 체크포인트 스타일 작업을 만들 수 있습니다. [작업 유형](../../campaign/using/creating-and-managing-tasks.md#types-of-task)을 참조하십시오.
...
#### 2단계 - 서비스 공급자를 구성하고 비용 구조 정의 {#step-2---configuring-the-service-provider-and-defining-the-cost-structures}

1. **[!UICONTROL Administration > Campaigns]** 노드에서 비용 구조를 사용하여 서비스 공급자 및 서비스 템플릿을 만듭니다. 자세한 내용은 [서비스 공급자 만들기 및 해당 비용 범주](../../campaign/using/providers--stocks-and-budgets.md#creating-a-service-provider-and-its-cost-categories)를 참조하십시오.

   DM 게재의 경우 비용 범주 **[!UICONTROL Envelopes]**(유형 114x229 및 162x229), **[!UICONTROL Postage]** 및 **[!UICONTROL Print]**(유형 A3 및 A4)를 만듭니다. 그리고 다음 비용 구조를 생성합니다.
...
게재와 관련된 비용 라인이 캠페인의 **[!UICONTROL Edit > Budget]** 탭에 추가됩니다. 계산 세부 사항을 보려면 이 필드를 편집합니다.
...
이 캠페인에 앞서 비용 구조가 생성된 두 가지 작업을 추가합니다( [2단계 - 서비스 공급자 구성 및 비용 구조 정의 참조). ](#step-2---configuring-the-service-provider-and-defining-the-cost-structures) 이렇게 하려면 캠페인 대시보드에서 **[!UICONTROL Add a task]** 버튼을 클릭합니다. 작업 이름을 지정하고 **[!UICONTROL Save]**&#x200B;을 클릭합니다.
...
각 서비스 공급자의 송장이 프로필의 **[!UICONTROL Invoices]** 탭에 표시됩니다.
