...
>[!NOTE]
>
>**[!UICONTROL collaborative campaigns (by campaign)]** 외에 이러한 캠페인은 웹 인터페이스를 통해 구성 및 실행할 수 있습니다.

공동 작업 캠페인 데이터베이스의 구성 프로세스는 로컬 캠페인 템플릿의 구성 프로세스와 유사합니다. 서로 다른 협업 캠페인 유형의 사양은 아래에 자세히 설명되어 있습니다.

### By form {#by-form}

협업 캠페인(폼)을 만들려면 **[!UICONTROL Collaborative campaign (by form)]** 템플릿을 선택해야 합니다.

![](assets/mkg_dist_mutual_op_form2.png)

**[!UICONTROL Edit]** 탭에서 **[!UICONTROL Advanced campaign settings...]** 링크를 클릭하여 **Distributed Marketing** 탭에 액세스합니다.

**양식** 웹 인터페이스를 선택합니다. 이 유형의 인터페이스를 사용하면 캠페인을 정렬할 때 로컬 엔티티에서 사용할 개인화 필드를 만들 수 있습니다. [로컬 캠페인 만들기(폼)](../../campaign/using/examples.md#creating-a-local-campaign--by-form-)를 참조하십시오.

캠페인을 저장합니다. 이제 **[!UICONTROL Create]** 단추를 클릭하여 **캠페인 패키지** 보기에서 사용할 수 있습니다.****

**[!UICONTROL Campaign Package]** 보기에서는 서로 다른 조직 개체에 대한 캠페인을 만들기 위해 협업 캠페인에 대한 참조 캠페인과 함께 로컬 캠페인 템플릿(기본적으로 또는 중복됨)을 사용할 수 있습니다.
...
**캠페인(캠페인별)**&#x200B;에 대한 주문이 중앙 엔티티에서 승인되면 로컬 엔터티에 대해 하위 캠페인이 생성됩니다. 로컬 엔티티가 다음 사항을 수정할 수 있습니다.
...
공동 작업 캠페인을 만들려면(대상 승인별) **[!UICONTROL Collaborative campaign (by target approval)]** 템플릿을 선택해야 합니다.
...
## 공동 작업 캠페인 패키지 {#creating-a-collaborative-campaign-package} 만들기
...
**협업 캠페인**&#x200B;의 경우 중앙 엔터티가 등록 및 개인화 최종 기한을 지정해야 합니다.

>[!NOTE]
>
>**[!UICONTROL Personalization deadline]**&#x200B;을 사용하면 중앙 엔터티가 캠페인을 구성하는 데 사용할 문서(스프레드시트, 이미지)를 배달해야 하는 기한을 선택할 수 있습니다. 이것은 필수 옵션이 아닙니다. 이 날짜를 사이드 단계 지정해도 캠페인 구현에 영향을 주지 않습니다.
...
**협업 캠페인**&#x200B;의 경우 주문 승인 모드를 지정할 수 있습니다.
...
공동 작업 캠페인이 캠페인 패키지 목록에 추가되면 중앙 엔티티가 정의한 대상에 속하는 로컬 엔티티에 알림이 표시됩니다(**공동 캠페인(대상 승인별)**&#x200B;에는 사전 정의된 대상이 없음). 전송된 메시지에는 아래와 같이 캠페인에 등록할 수 있는 링크가 포함되어 있습니다.
