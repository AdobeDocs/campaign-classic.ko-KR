...
>[!NOTE]
>
>**[!UICONTROL Administrator]** 권한이 있는 다른 모든 [!DNL Adobe Campaign] 연산자도 작업을 승인할 수 있지만 알림을 받지 않습니다.\
...
알림 콘텐츠가 특정 템플릿에 정의되어 있습니다. **[!UICONTROL Notification of validations for the marketing campaign]**. 이 템플릿은 [!DNL Adobe Campaign] 트리의 **[!UICONTROL Administration > Campaign management > Technical delivery templates]** 폴더에 저장됩니다.
...
1. 콘텐츠 편집 담당자는 게재 콘텐츠를 변경하고 나면 콘텐츠를 사용 가능하게 만들 수 있습니다.
   ...
   * [!DNL Adobe Campaign] 콘솔을 통해 **[!UICONTROL Available content]** 링크를 클릭합니다.
