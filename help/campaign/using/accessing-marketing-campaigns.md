...
Adobe Campaign에 연결되면 탐색 막대에서 링크를 사용하여 다양한 기능을 탐색합니다.


![](assets/campaign_global_view.png)


캠페인 요소는 **[!UICONTROL Campaigns]** 탭: 마케팅 프로그램, 캠페인 및 하위 세트에 대한 개요를 볼 수 있습니다. 마케팅 프로그램은 게재, 작업, 연결된 리소스 등으로 구성된 캠페인으로 구성됩니다. Campaign을 사용한 마케팅 캠페인 관리 컨텍스트에서 게재, 예산, 검토자 및 연결된 문서에 대한 정보가 캠페인에서 제공됩니다.
...
캠페인 달력에 표시되는 정보를 필터링할 수 있습니다. 를 클릭합니다. **[!UICONTROL Filter]** 을(를) 연결하고 필터링 기준을 선택합니다.

![](assets/campaign_planning_filter.png)

>[!NOTE]
>
>날짜를 필터링하면 시작 날짜가 지정된 날짜보다 이후이거나 지정된 날짜보다 빠른 종료 날짜가 있는 모든 캠페인이 표시됩니다. 각 필드 오른쪽에 있는 달력을 사용하여 날짜를 선택합니다.
...
캠페인은 게재 집합을 중앙 집중화합니다. 각 캠페인에 대해 예약은 모든 구성 요소에 대한 전역 보기를 제공합니다. 작업 및 게재를 표시하고 쉽게 액세스할 수 있습니다.
...
추가 정보 [토론 포럼](../../mrm/using/discussion-forums.md).
...
* 참조 [문서 및 리소스](../../campaign/using/marketing-campaign-deliveries.md#managing-associated-documents): 캠페인에 문서(개요, 보고서, 이미지 등)를 연결할 수 있습니다. 모든 문서 형식이 지원됩니다.
* 비용 정의: Adobe Campaign에서는 각 캠페인에 대해 [원가 항목 및 원가 계산 구조](../../campaign/using/providers--stocks-and-budgets.md#defining-cost-categories) 마케팅 캠페인을 만들 때 사용할 수 있는 구성 요소입니다. 예: 인쇄비, 외부 기관 사용, 객실 대여
...
* 승인 관리: 승인할 처리를 선택할 수 있으며, 필요한 경우 검토 연산자 또는 연산자 그룹을 선택합니다. [자세히 알아보기](../../campaign/using/marketing-campaign-approval.md#checking-and-approving-deliveries)
...
| 캠페인 주문 | 주문 만들기<br/>주문 수락 또는 거부 <!-- Je n'ai pas pu créer de campaign order pour vérifier cela. Peut-on accéder à ces fonctionnalités depuis l'accès web ? --> |
| 재고 | 재고 라인 삭제 |
