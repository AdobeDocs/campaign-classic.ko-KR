...
캠페인 요소는에서 찾을 수 있습니다. **[!UICONTROL Campaigns]** 탭: 여기에서 마케팅 프로그램, 캠페인 및 하위 세트에 대한 개요를 볼 수 있습니다. 마케팅 프로그램은 게재, 작업, 연결된 리소스 등으로 구성되는 캠페인으로 구성됩니다. Campaign을 사용한 마케팅 캠페인 관리의 맥락에서 게재, 예산, 검토자 및 연결된 문서에 대한 정보는 캠페인에서 찾을 수 있습니다.
...
캠페인 캘린더에 표시되는 정보를 필터링할 수 있습니다. **[!UICONTROL Filter]** 필터링 기준을 연결하고 선택합니다.
...
다음에서 자세히 알아보기 [토론 포럼](../../mrm/using/discussion-forums.md).
