...
>[!NOTE]
>
> 하이브리드 및 호스팅 아키텍처의 경우 [중간 소싱 서버](../../installation/using/mid-sourcing-server.md) 및 [실행 인스턴스](../../message-center/using/configuring-instances.md#execution-instance)를 포함한 모든 서버에 패키지를 설치해야 합니다.
...
1. **[!UICONTROL AMP support]** 패키지를 설치합니다. [Campaign 기본 제공 패키지 설치](../../installation/using/installing-campaign-standard-packages.md)를 참조하세요.
...
>[!NOTE]
>
>특정 도메인이 AMP 이메일을 수신하지 못하도록 메일 처리 규칙을 만들 수 있습니다. [전자 메일 형식 관리](../../installation/using/email-deliverability.md#managing-email-formats)를 참조하세요.
>
