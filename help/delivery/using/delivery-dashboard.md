...
>
>이 페이지는 하이브리드 및 온-프레미스 배포를 위한 **Campaign Classic v7 관련 사용자 지정**&#x200B;을 문서화합니다.

캠페인이 효율적이고 고객에게 도달하도록 하려면 게재 모니터링이 필수적입니다.

게재 목록 액세스, 게재 대시보드 탭 사용 및 게재 모니터링에 대한 자세한 내용은 [Campaign v8 게재 모니터링 Campaign UI 설명서](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/monitor/delivery-dashboard){target="_blank"}를 참조하세요.
...
* [바운스 메일 구성](understanding-delivery-failures.md)(v7 하이브리드/온-프레미스)
