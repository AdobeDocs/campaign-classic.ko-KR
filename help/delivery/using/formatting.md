...
* **content.@name**: 기본 요소의 &quot;name&quot; 특성 값을 검색합니다.
* **content.@`['name']`**: **content.@name** 구문과 동일합니다.
...
프로그래밍 언어의 모든 기능(변수, 루프, 조건부 테스트, 함수 등)은 출력 문서를 구성하는 데 사용할 수 있습니다. SOAP API를 사용하여 출력 문서를 보강할 수 있습니다.
