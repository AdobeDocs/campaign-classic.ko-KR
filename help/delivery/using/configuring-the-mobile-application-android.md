...
1. 클릭 **[!UICONTROL Finish]** 그러면 **[!UICONTROL Save]**. 이제 Android 애플리케이션을 Campaign Classic에서 사용할 준비가 되었습니다.
...
다음을 확장해야 합니다. **appsubscriptionRcp** Campaign 데이터베이스에 있는 앱의 매개 변수를 저장할 새 추가 필드를 정의합니다. 이러한 필드는 예를 들어 개인화에 사용됩니다. 방법은 다음과 같습니다.
