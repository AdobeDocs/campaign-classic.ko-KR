...
1. 을(를) 추가할 수 있습니다 **[!UICONTROL Subtitle]**: iOS 알림 페이로드의 자막 매개 변수 값입니다. 자세한 내용은 [이 섹션](configuring-the-mobile-application.md).

1. 메시지의 내용을 **[!UICONTROL Message content]** 섹션에 나열된 상태로 남아 있습니다. 개인화 필드 사용은 [개인화 기본 정보](about-personalization.md) 섹션을 참조하십시오.
...
1. 에서 **[!UICONTROL Application variables]** 탭, **[!UICONTROL Application variables]** 은 구성 단계 동안 추가된 내용에 따라 자동으로 추가됩니다.
...
1. 에서 **[!UICONTROL Advanced]** 탭에서 다음을 확인합니다 **[!UICONTROL Mutable content]** 상자를 사용하여 모바일 애플리케이션에서 미디어 콘텐츠를 다운로드할 수 있습니다.
