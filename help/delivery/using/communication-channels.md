...
>[!NOTE]
>
>Adobe Campaign은 게재 기능을 모니터링하고 이메일 전송을 최적화하는 도구 세트를 제공합니다. 자세한 내용은 [이 섹션](../../delivery/using/about-deliverability.md)을 참조하십시오.
...
1. **이메일 채널**: 이메일 게재를 사용하면 개인화된 이메일을 대상 모집단으로 보낼 수 있습니다. [전자 메일 채널 정보](../../delivery/using/about-email-channel.md)를 참조하십시오.
1. **DM 채널**: DM 게재는 대상 모집단에서 데이터를 포함하는 추출 파일을 생성할 수 있습니다. [다이렉트 메일 채널 정보](../../delivery/using/about-direct-mail-channel.md)를 참조하십시오.
1. **모바일 채널**:모바일 채널의 게재를 사용하면 개인화된 SMS 또는 LINE 메시지를 대상 모집단으로 보낼 수 있습니다. [SMS 채널](../../delivery/using/sms-channel.md)을 참조하십시오.
1. **모바일 앱 채널**:모바일 앱 게재를 사용하면 iOS 및 Android 시스템에 알림을 전송할 수 있습니다. [모바일 앱 채널](../../delivery/using/about-mobile-app-channel.md) 장을 참조하십시오.
...
[이메일 채널](../../delivery/using/about-email-channel.md)은(는) Adobe Campaign의 핵심 채널 중 하나이며, 특정 타겟에 개인화된 이메일을 예약하고 보낼 수 있습니다.
...
게재 사용량 및 권장 사항에 대해 알아보려면 Campaign [게재 모범 사례](../../delivery/using/delivery-best-practices.md)를 참조하십시오.

다른 유형의 게재에 대한 자세한 내용은 [이 섹션](#types-of-deliveries)을 참조하십시오.

## 모바일 게재 {#mobile-deliveries}

Adobe Campaign에서는 모바일에서 [SMS](../../delivery/using/sms-channel.md) 및 [LINE](../../delivery/using/line-channel.md) 메시지를 제공할 수 있습니다.
...
Adobe Campaign을 사용하면 전용 앱을 통해 iOS 및 Android 모바일 장치에서 개인화 및 세그먼트화한 [푸시 알림](../../delivery/using/about-mobile-app-channel.md)을 보낼 수 있습니다. 구성 및 통합 단계를 수행하면 iOS 및 Android 게재를 만들고 전송할 수 있습니다. 이미지나 비디오로 풍부한 알림을 디자인할 수도 있습니다.
...
Adobe Campaign에서는 외부 게재를 만드는 데 사용되는 전화 배달 템플릿을 제공합니다. 이 채널을 사용하면 출력 파일을 처리하는 전용 방법론을 설정할 수 있습니다. 구성 단계는 [DM 채널](../../delivery/using/about-direct-mail-channel.md)과 동일합니다.
