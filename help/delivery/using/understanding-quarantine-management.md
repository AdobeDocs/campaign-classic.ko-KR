...
* 상태를 로 변경할 수도 있습니다 **[!UICONTROL On allow list]**. 이 경우 주소는 격리 목록에 남아 있지만 오류가 발생하더라도 체계적으로 타깃팅됩니다.
...
>[!IMPORTANT]
주소가 **[!UICONTROL Quarantine]** 있거나 **[!UICONTROL On block list]** 상태가 있는 수신자는 이메일을 수신하더라도 제거되지 않습니다.

오류 수와 두 오류 사이의 기간을 수정할 수 있습니다. 이렇게 하려면 배포 마법사에서 해당 설정을 변경합니다(**[!UICONTROL Email channel]** > **[!UICONTROL Advanced parameters]**). 배포 마법사에 대한 자세한 내용은 [이 섹션을 참조하십시오](../../installation/using/deploying-an-instance.md).
