...
HTTP/V2 프로토콜을 사용하면 각 푸시 전달에 대한 직접적인 피드백과 상태를 확인할 수 있습니다. HTTP/V2 프로토콜 커넥터를 사용하는 경우, 피드백 서비스는 더 이상 **[!UICONTROL mobileAppOptOutMgt]** 워크플로우에서 호출되지 않습니다. 모바일 응용 프로그램을 제거하거나 다시 설치한 경우 토큰은 등록되지 않은 것으로 간주됩니다.
