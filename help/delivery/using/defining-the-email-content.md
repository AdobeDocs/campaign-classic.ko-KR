...
>[!NOTE]
>
>개인화 필드 사용은 [개인화 정보](../../delivery/using/about-personalization.md)에 나와 있습니다.
...
이모티콘 목록을 사용자 지정하려면 이 [page](../../delivery/using/customizing-emoticon-list.md)을 참조하십시오.
...
>[!NOTE]
>
>성능 문제를 방지하려면 개인화된 URL에서 즉시 다운로드한 이미지를 [첨부 파일](../../delivery/using/attaching-files.md)로 포함하는 경우 각 이미지 크기는 기본적으로 100,000바이트를 초과해서는 안 됩니다. 이 권장 임계값은 [Campaign Classic 옵션 목록에서 구성할 수 있습니다](../../installation/using/configuring-campaign-options.md#delivery).
