...
1. 게재 편집기에서 **[!UICONTROL To]** 을 선택합니다.
...
1. **[!UICONTROL Add]** 단추를 클릭하여 제한 필터를 정의합니다.
   ...
   데이터베이스에 정의된 타겟팅 유형을 사용하여 수신자를 선택할 수 있습니다. 대상 유형을 사용하려면 대상 유형을 선택하고 **[!UICONTROL Next]** 을 클릭합니다. 각 대상에 대해 **[!UICONTROL Preview]** 탭을 클릭하여 관련 수신자를 표시할 수 있습니다. 특정 유형의 타깃팅에 대해 **[!UICONTROL Refine target]** 버튼을 사용하면 여러 타깃팅 기준을 결합할 수 있습니다.
...
1. 구성된 타겟팅의 유효성을 검사하려면 **[!UICONTROL Finish]** 을 클릭하십시오.
...
1. **[!UICONTROL Finish]** 을 클릭하고 게재를 표준 게재로 구성합니다.
...
>[!NOTE]
>
>일반적으로 증명의 대상을 기본 타겟에 추가할 수 있습니다. 이렇게 하려면 **[!UICONTROL Main target]** 탭의 아래 섹션에서 적절한 옵션을 선택합니다.
...
1. 다음 예와 같이 **[!UICONTROL Detail]** 아이콘을 클릭하여 기본 대상에서 프로필을 선택합니다.
