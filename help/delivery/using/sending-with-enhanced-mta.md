...
이제 Adobe Campaign을 업그레이드하여 고성능 이메일 게재 엔진인 **Enhanced MTA**(메일 전송 에이전트)을(를) 사용할 수 있습니다.
...
다시 시도에 대한 자세한 내용은 **게재 전송** > **다시 시도 구성**&#x200B;에서 이 [페이지](communication-channels.md)를 참조하십시오.
...
유효 기간에 대한 자세한 내용은 **게재 전송** > **유효 기간 정의**&#x200B;에서 이 [페이지](communication-channels.md)를 참조하십시오.
