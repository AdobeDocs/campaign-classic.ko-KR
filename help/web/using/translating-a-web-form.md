...
하나 이상의 번역 언어를 정의하려면 웹 응용 프로그램의 **[!UICONTROL Properties]** 버튼을 클릭한 다음 **[!UICONTROL Localization]** 탭을 클릭합니다. **[!UICONTROL Add]** 단추를 클릭하여 웹 응용 프로그램의 새 번역 언어를 정의합니다.
...
수집 프로세스에서 번역이 이미 있음을 감지하면 이 번역이 문자열의 **[!UICONTROL Text]** 열에 표시됩니다. 문자열의 상태가 **[!UICONTROL Translated]**(으)로 설정됩니다.
...
**[!UICONTROL Language]** 드롭다운 상자로 이동하여 번역 언어를 선택합니다.
...
1. 아래 섹션에 번역을 입력합니다. 승인하려면 **[!UICONTROL Translation approved]** 옵션을 선택합니다.
   ...
   승인되지 않은 번역은 **[!UICONTROL Translated]**(으)로 표시됩니다. 승인된 번역은 **[!UICONTROL Approved]**&#x200B;로 표시됩니다.
...
1. 내보낼 문자열이 있는 웹 응용 프로그램을 선택하고 마우스 오른쪽 단추를 클릭한 다음 **[!UICONTROL Actions > Export strings for translation...]** 을 선택합니다.
...
1. 그런 다음 파일을 기록할 **[!UICONTROL Target folder]**&#x200B;을(를) 선택합니다.
...
>[!NOTE]
>
>내보내기 파일의 이름은 자동으로 생성됩니다. 동일한 내보내기를 여러 번 수행하면 기존 파일이 새 파일로 대체됩니다. 이전 파일을 유지해야 하는 경우 **[!UICONTROL Target folder]** 을 변경한 다음 **[!UICONTROL Start]** 를 다시 클릭하여 내보내기를 실행합니다.
...
1. 웹 응용 프로그램 목록으로 이동한 후 마우스 오른쪽 단추를 클릭한 다음 **[!UICONTROL Actions > Import translated strings...]** 을 선택합니다.
...
1. 가져올 파일을 선택하고 **[!UICONTROL Upload]** 을 클릭합니다.
...
>[!NOTE]
>
>각 언어에 대한 기호 목록은 [양식 변경 표시 언어](#changing-forms-display-language)에 자세히 설명되어 있습니다.
...
1. 창의 위쪽 섹션에서 변환할 시스템 문자열을 선택한 다음 아래 섹션에서 **[!UICONTROL Add]** 를 클릭합니다.
...
웹 응용 프로그램을 기본 언어 이외의 언어로 변환하려면( [양식 변경 표시 언어](#changing-forms-display-language) 참조) 새 번역 언어를 추가해야 합니다.

1. Adobe Campaign 트리의 **[!UICONTROL Administration > Platform > Enumerations]** 노드를 클릭하고 목록에서 **[!UICONTROL Languages available for translation]** 를 선택합니다. 사용 가능한 번역 목록이 창의 아래 섹션에 표시됩니다.
