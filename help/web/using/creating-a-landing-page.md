...
Adobe Campaign에서 랜딩 페이지 구성을 시작하기 전에 HTML 페이지를 나타내는 템플릿 **** 하나 이상이 있는지 확인하십시오.

이 사용 사례의 주요 목표는 랜딩 페이지 양식 필드가 DCE의 기능을 사용하여 Adobe Campaign의 내부 필드와 일치하도록 만드는 것입니다.

## Creating the landing page {#creating-the-landing-page}

새 랜딩 페이지 유형 웹 애플리케이션을 만들려면 다음 단계를 수행하십시오.

1. 탭으로 **[!UICONTROL Campaigns]** 가서 **[!UICONTROL Web application]** 링크를 클릭한 다음 **[!UICONTROL Create]** 단추를 클릭합니다.
...
>[!NOTE]
>
>웹 응용 프로그램 만들기에 대한 자세한 내용은 [이 섹션을 참조하십시오](../../web/using/creating-a-new-web-application.md).

## 1단계 - 템플릿 선택 및 로드 {#step-1---selecting-and-loading-templates}

이 섹션에서는 웹 애플리케이션의 각 페이지에 대한 HTML 컨텐츠 **** 를 가져오는 방법을 살펴보겠습니다.
...
1. 컨텐츠 템플릿 **[!UICONTROL From a file]** 을 페치하려면 선택합니다.
...
1. 열기를 **클릭하여** 가져오기를 시작합니다.
   ...
   가져오기가 끝나면 **[!UICONTROL Close]** 단추를 클릭합니다.
...
1. 각 페이지의 **레이블을** 입력합니다(예:1페이지= 수집, 2페이지=감사).
...
이 섹션에서는 가져온 컨텐츠를 조정하고 데이터베이스의 필드를 웹 페이지의 양식으로 연결합니다. 이전에 만든 웹 응용 프로그램은 다음과 같습니다.

![](assets/dce_uc1_lp_enchainement.png)

### 컨텐츠 수정 {#modifying-content}

페이지의 색상을 변경하는 것부터 시작합시다. 방법은 다음과 같습니다.
...
1. 양식 필드를 선택합니다.
1. 편집기의 **[!UICONTROL Field]** 오른쪽에 있는 섹션을 편집합니다.
...
필드를 필수 필드로 만들 수 있습니다.예를 들어, 필드를 **[!UICONTROL Email]** 클릭한 다음 필수 **옵션을 활성화합니다** .
...
1. 페이지의 **[!UICONTROL Send it!]** 단추를 **[!UICONTROL Collection]** 선택합니다.
...
1. 도구 모음 **[!UICONTROL Personalization field]** 의 **[!UICONTROL Insert]** 메뉴에서 을 선택합니다.
1. 이름을 선택합니다.
...
컨텐츠는 웹 애플리케이션 대시보드에서 게시됩니다. 단추를 **[!UICONTROL Publish]** 클릭하여 실행합니다.

![](assets/dce_uc1_pub_dashboard.png)

게시 중에 로그가 표시됩니다. 게시 시스템은 웹 응용 프로그램에서 찾은 모든 내용을 분석합니다
...
이제 양식을 사용할 수 있습니다.애플리케이션 대시보드에서 액세스할 수 있으며 수신자에게 전송할 수 있습니다.
