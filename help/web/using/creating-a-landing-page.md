...
1. **[!UICONTROL Campaigns]** 탭으로 이동하여 **[!UICONTROL Web application]** 링크를 클릭한 다음 **[!UICONTROL Create]** 버튼을 클릭합니다.
1. **[!UICONTROL New landing page]** 템플릿을 선택하고 레이블을 입력한 다음 **[!UICONTROL Save]** 를 클릭합니다.
...
1. **페이지 2** 활동을 편집한 다음 **[!UICONTROL Properties]** 탭에서 **[!UICONTROL Activate outbound transitions]** 옵션을 선택 취소합니다.
...
이 섹션에서는 웹 애플리케이션의 각 페이지에 대해 **HTML content**&#x200B;를 가져오는 방법을 살펴보겠습니다.
...
1. 컨텐츠 템플릿을 가져오려면 **[!UICONTROL From a file]** 을 선택합니다.
...
1. **열기**&#x200B;를 클릭하여 가져오기를 시작합니다.
   ...
   가져오기가 완료되면 **[!UICONTROL Close]** 버튼을 클릭합니다.
...
1. 양식 필드를 선택합니다.
1. 편집기 오른쪽에서 **[!UICONTROL Field]** 섹션을 편집합니다.
...
1. **[!UICONTROL Next page]** 작업을 선택합니다.
