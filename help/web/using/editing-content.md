...
>[!NOTE]
>
>고급 표현식 편집은 [이 페이지에 표시됩니다](../../platform/using/defining-filter-conditions.md#list-of-functions).

![](assets/dce_popup_visibilitycondition.png)

이러한 조건은 XTK 표현식 구문(예: **ctx.recipient)을 채택합니다.@email!= &quot;&quot;** 또는 **ctx.recipient.@status==&quot;0&quot;**). 기본적으로 모든 필드가 표시됩니다.
...
기본적으로 제공되는 필드는 **nms:recipient** 테이블의 필드입니다.

![](assets/dce_field_selection.png)

**필수 필드** 옵션을 사용하면 사용자가 해당 필드를 입력한 경우에만 페이지의 승인을 승인할 수 있습니다. 필수 필드를 입력하지 않은 경우 오류 메시지가 표시됩니다.
...
* 항목 목록 값(선택한 필드에 정의됨)을 **[!UICONTROL Value]** 필드에 입력합니다.
...
디지털 콘텐츠 편집기를 사용하면 브라우저와 호환되는 이미지&#x200B;**의 모든 유형에 대해 작업할 수 있습니다.**
...
* **** 캡션을 사용하면 이미지에 연결된 캡션( **** altHTML 속성에 해당됨)을 정의할 수 있습니다.
* **** 차원은 이미지 크기를 픽셀 단위로 지정합니다.
...
삽입 아이콘에 대한 **개인화 필드** 옵션을 사용하면 수신자의 이름과 같은 데이터베이스 필드를 콘텐츠에 추가할 수 있습니다. 이 옵션은 텍스트 유형 블록에만 사용할 수 있습니다.

![](assets/dce_toolbar_textblock_persofield.png)

기본적으로 제공되는 필드는 **[!UICONTROL Recipient]** 테이블에서 가져옵니다. 필요한 경우 웹 응용 프로그램 속성을 편집하여 다른 테이블을 선택합니다.
...
기본 제공 개인화 블록 및 사용자 지정 개인화 블록을 정의하는 방법에 대한 자세한 내용은 [이 페이지](../../delivery/using/personalization-blocks.md)을 참조하십시오.
