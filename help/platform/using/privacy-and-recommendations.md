...
* **Adobe Experience Cloud이 정보를 수집하는 방법**
   ...
   * 또한 모바일 앱에서 Adobe Experience Cloud 기술을 사용할 수 있습니다. Campaign을 사용하여 모바일 게재 전송에 대한 자세한 내용은 [SMS 채널](../../delivery/using/sms-channel.md) 및 [모바일 앱 채널을 참조하십시오](../../delivery/using/about-mobile-app-channel.md).
...
Adobe Campaign은 추적 기능 덕분에 두 가지 유형의 쿠키를 사용하여 배달 받는 사람의 탐색을 추적할 수 있습니다.
...
또한, 받는 사람이 웹 사이트를 검색하는 방식을 모니터링할 수 있습니다.추적 태그를 삽입하여 웹 애플리케이션 페이지에서 정보를 수집하고 방문을 측정합니다. 자세한 내용은 웹 애플리케이션 [추적을 참조하십시오](../../web/using/tracking-a-web-application.md).

웹 추적 구성은 [이 섹션에 나와 있습니다](../../configuration/using/about-web-tracking.md).

추적을 추가로 관리하기 위해 Adobe Campaign을 사용하면 옵트아웃 배너를 표시하여 행동 추적을 옵트아웃한 최종 사용자의 웹 동작 추적을 중지할 수 있습니다. 자세한 내용은 [웹 애플리케이션 추적 옵트아웃을 참조하십시오](../../web/using/web-application-tracking-opt-out.md).
