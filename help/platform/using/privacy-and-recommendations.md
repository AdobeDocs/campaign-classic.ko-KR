...
* **Adobe Experience Cloud을 정보를 수집하는 데 사용하는 방법**
   ...
   * 또한 모바일 앱에서 Adobe Experience Cloud 기술을 사용할 수 있습니다. Campaign을 사용하여 모바일 게재를 전송하는 방법에 대한 자세한 내용은 [SMS 채널](../../delivery/using/sms-channel.md) 및 [모바일 앱 채널](../../delivery/using/about-mobile-app-channel.md)을 참조하십시오.
...
개인 정보 관리는 개인 정보 보호 규정(GDPR, CPA 등)을 준수하는 데 도움이 되는 모든 프로세스 및 도구를 의미합니다. [이 페이지](privacy-and-recommendations.md)에서 개인 정보 관리 기능에 대한 개요를 살펴보십시오.
