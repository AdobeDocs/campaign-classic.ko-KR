...
[Campaign v8(콘솔) 설명서](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/audience/create-filters){target=_blank}에서 **필터에 액세스, 디자인 및 공유**&#x200B;하는 방법에 대해 알아봅니다.
...
[Campaign v8(콘솔) 설명서](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/config/configuration/ui-settings#customize-lists){target=_blank}에서 **목록을 관리하고 사용자 지정**&#x200B;하는 방법에 대해 알아봅니다.
