...
[Campaign v8의 추적 로그](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/tracking-logs){target="_blank"} 또는 [v7별 추적](../../delivery/using/about-message-tracking.md)에 대해 자세히 알아보세요.
+++
