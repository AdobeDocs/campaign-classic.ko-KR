...
[A/B 테스트](../../delivery/using/get-started-a-b-testing.md)에 대해 자세히 알아보세요.
+++
...
[액세스 관리](access-management.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서]&#x200B;(https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/activities)에서 워크플로우 활동에 대해 자세히 알아보세요.
.html){target="_blank"}.
+++
...
[활성 프로필](../../platform/using/about-profiles.md#active-profiles)에 대해 자세히 알아보세요.
+++
...
대상자에 대한 자세한 내용은 [Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-target.html?lang=ko){target="_blank"}를 참조하세요.
+++
...
[감사 추적](../../production/using/audit-trail.md)에 대해 자세히 알아보세요.
+++
...
[상호 작용](../../interaction/using/interaction-and-offer-management.md)에 대해 자세히 알아보세요.
+++
...
채널은 통신을 전송하는 매체입니다. Adobe Campaign의 기본 제공 채널에는 이메일, SMS, DM, 푸시 알림, LINE 및 X(이전에는 Twitter라고 함)가 있습니다. 비표준 채널 요구 사항에 맞게 사용자 지정 채널을 구현할 수 있습니다.

[채널](../../delivery/using/communication-channels.md)에 대해 자세히 알아보세요.
+++
...
[클라이언트 콘솔](../../platform/using/adobe-campaign-workspace.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-approval.html?lang=ko){target="_blank"}에서 콘텐츠 승인에 대해 자세히 알아보세요.
...
[Campaign 컨트롤 패널](https://experienceleague.adobe.com/docs/control-panel/using/discover-control-panel/key-features.html?lang=ko)에 대해 자세히 알아보세요.
+++
...
[큐브](../../reporting/using/ac-cubes.md)에 대해 자세히 알아보세요.
+++
...
[사용자 지정 리소스](../../configuration/using/about-schema-edition.md)에 대해 자세히 알아보세요.
+++
...
[데이터 모델](../../configuration/using/about-data-model.md)에 대해 자세히 알아보세요.
+++
...
[데이터베이스 정리 워크플로우](../../production/using/database-cleanup-workflow.md)에 대해 자세히 알아보세요.
+++
...
[게재](../../delivery/using/communication-channels.md)에 대해 자세히 알아보세요.
+++
...
[설명 분석](../../reporting/using/about-descriptive-analysis.md)에 대해 자세히 알아보기
+++
...
Distributed Marketing 추가 기능은 중앙 엔터티(본사, 마케팅 부서 등) 간의 캠페인을 구현하기 위한 공동 작업 영역을 캠페인 운영자에게 제공합니다 및 로컬 엔티티(판매 지점, 지역 에이전시 등). 이러한 협력은 공유 작업 공간(**캠페인 패키지 목록**)을 기반으로 하는데, 여기서 중앙에서 만든 캠페인 템플릿 및 인스턴스가 로컬 엔터티에 제공됩니다.

분산 마케팅에 대한 자세한 내용은 [Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/distributed-marketing/about-distributed-marketing.html?lang=ko){target="_blank"}를 참조하세요.
+++
...
[값 배포](../../platform/using/adobe-campaign-workspace.md#about-queries-in-campaign)에 대해 자세히 알아보기
+++

+++**도메인 위임**

하위 도메인 구성을 통해 Adobe Campaign에서 사용할 도메인의 하위 섹션(기술적 명칭은 [DNS 영역])을 구성할 수 있습니다.
도메인 위임을 통해 Adobe은 이메일 캠페인 게재, 렌더링 및 추적에 필요한 DNS의 모든 측면을 제어하고 유지 관리할 수 있습니다.

[도메인 위임](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html?lang=ko)에 대해 자세히 알아보기
+++
...
[자격 규칙](../../interaction/using/interaction-and-offer-management.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/emails/email-bcc.html){target="_blank"}에서 이메일 BCC에 대해 자세히 알아보세요.
+++
...
[외부 계정](../../installation/using/external-accounts.md)에 대해 자세히 알아보세요.
+++
...
[페더레이션 데이터 액세스](../../installation/using/about-fda.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/direct-mail.html#validating){target="_blank"}에서 파일 추출 승인에 대해 자세히 알아보세요.
+++
...
[Forms](../../configuration/using/identifying-a-form.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/heatmap.html?lang=ko){target="_blank"}를 참조하세요.
+++
...
[하이브리드 배포](../../installation/using/hosting-models.md#hybrid)에 대해 자세히 알아보세요.
...
[인바운드 상호 작용](../../interaction/using/about-inbound-channels.md)에 대해 자세히 알아보세요.
+++
...
[받은 편지함 렌더링](../../delivery/using/inbox-rendering.md)에 대해 자세히 알아보세요.
+++
...
[인스턴스 설정](../../installation/using/about-initial-configuration.md)에 대해 자세히 알아보세요.
...
[목록](../../platform/using/creating-and-managing-lists.md)에 대해 자세히 알아보세요.
+++
...
[로컬 캐시](../../platform/using/faq-campaign-classic-v7.md#how-do-i-clear-console-cache)에 대해 자세히 알아보세요.
+++
...
Adobe Campaign의 **마케팅 리소스 관리(MRM)** 모듈을 사용하면 관련된 작업, 예산 및 마케팅 리소스에 대한 완전한 관리 및 실시간 추적을 제공하여 공동 작업 모드에서 마케팅 작업을 제어할 수 있습니다. Adobe Campaign 운영자는 보고, 승인 추적, 알림, 토론 포럼 등 완벽한 유효성 검사 프로세스 및 적절한 추적 도구를 통해 모든 단계에서 작업을 조정하고 진행 상황을 승인할 수 있습니다.

[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/mrm/about-marketing-resource-management.html?lang=ko){target="_blank"}에서 MRM에 대해 자세히 알아보세요.
+++
...
[명명된 권한](../../platform/using/access-management-named-rights.md)에 대해 자세히 알아보세요.
+++
...
[네임스페이스](../../configuration/using/about-schema-reference.md#identification-of-a-schema)에 대해 자세히 알아보세요.
+++
...
[오퍼 카탈로그](../../interaction/using/offer-catalog-overview.md)에 대해 자세히 알아보세요.
+++
...
* **확인된 연락처**: 채널에서 자발적으로 확인된 연락처입니다. 아웃바운드 상호 작용에서 연락처는 자동으로 식별됩니다.
* **익명 연락처**: 채널을 통해 자발적으로 구독한 것은 아니지만 쿠키를 통해 암시적으로 식별할 수 있는 연락처입니다. 이 용어는 수신 상호 작용에만 사용됩니다.
...
오퍼 **디자인 환경**&#x200B;은(는) 운영자가 오퍼를 만들고, 유형화 규칙을 정의하고, 오퍼가 타깃팅할 스키마를 선택하는 환경입니다. 생성된 오퍼 제안을 저장하는 테이블은 환경에 의해서도 정의됩니다. 기본적으로 상호 작용 추가 기능에는 **디자인** 환경 및 **라이브** 환경이 연결되어 있습니다. 두 환경 모두 기본 제공 수신자 테이블을 타겟팅하도록 사전 구성되어 있습니다.

[오퍼 디자인 환경](../../interaction/using/fundamental-principles.md)에 대해 자세히 알아보세요.
+++
...
[오퍼 환경](../../interaction/using/fundamental-principles.md)에 대해 자세히 알아보세요.
+++
...
Offer Live 환경이 Campaign **디자인 환경**&#x200B;에 연결되어 있습니다. **디자인 환경**&#x200B;을 통해 콘텐츠 및 자격이 승인된 읽기 전용 오퍼가 포함되어 있습니다. 웹 사이트에 프레젠테이션하거나 아웃바운드 메시지에 삽입하도록 선택할 수 있습니다.

[라이브 환경 제공](../../interaction/using/fundamental-principles.md)에 대해 자세히 알아보세요.
+++
...
[오퍼 프레젠테이션 규칙](../../interaction/using/managing-offer-presentation.md#presentation-rules-overview)에 대해 자세히 알아보세요.
+++
...
[오퍼 미리 보기](../../interaction/using/creating-an-offer.md#previewing-the-offer)에 대해 자세히 알아보세요.
+++
...
[오퍼 제안](../../interaction/using/creating-offer-spaces.md#offer-proposition-statuses)에 대해 자세히 알아보세요.
+++
...
오퍼 표현은 오퍼를 표시하기 위해 채널에서 사용하는 정보입니다. 오퍼 표현은 오퍼가 표시되거나 인터페이스에 직접 입력된 공간의 렌더링 기능으로 구성될 수 있습니다(예: HTML 블록). 오퍼는 공백으로 표시될 수 있습니다.
...
[오퍼 스페이스](../../interaction/using/creating-offer-spaces.md)에 대해 자세히 알아보세요.
+++
...
[오퍼 테마](../../interaction/using/integrating-an-offer-via-the-wizard.md)에 대해 자세히 알아보세요.
+++
...
[오퍼 가중치](../../interaction/using/creating-an-offer.md#offer-weight)에 대해 자세히 알아보세요.
+++
...
[연산자](../../platform/using/access-management-operators.md)에 대해 자세히 알아보세요.
+++
...
[연산자 그룹](../../platform/using/access-management-groups.md)에 대해 자세히 알아보세요.
+++
...
[옵션](../../installation/using/configuring-campaign-options.md)에 대해 자세히 알아보세요.
+++
...
[아웃바운드 상호 작용](../../interaction/using/about-outbound-channels.md)에 대해 자세히 알아보세요.
+++
...
[패키지 내보내기/가져오기](../../platform/using/working-with-data-packages.md)에 대해 자세히 알아보세요.
+++
...
[성능 모니터링](../../production/using/monitoring-processes.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/set-up-campaigns.html?lang=ko){target=_blank}에서 플랜에 대해 자세히 알아보세요.
+++
...
[기본 키](../../configuration/using/schema/key.md)에 대해 자세히 알아보세요.
+++
...
[프로필](../../platform/using/about-profiles.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/set-up-campaigns.html?lang=ko){target=_blank}에서 프로그램에 대해 자세히 알아보세요.
+++
...
[공개 리소스](../../installation/using/deploying-an-instance.md#managing-public-resources)에 대해 자세히 알아보세요.
+++
...
푸시 알림은 모바일 애플리케이션에서 수신하는 메시지입니다. 푸시 알림은 모바일 애플리케이션에 Experience Platform SDK 코드를 포함하여 Adobe Campaign에서 작동하도록 구성됩니다. 푸시의 경우 iOS 및 Android, 이렇게 두 가지 게재 채널을 사용할 수 있습니다.

[푸시](../../delivery/using/about-mobile-app-channel.md)에 대해 자세히 알아보세요.
+++
...
렌더링 함수는 오퍼 공간에서 정의됩니다. 오퍼에 정의된 속성을 기반으로 오퍼 표현을 구성하는 데 사용됩니다. 렌더링 함수 모드에는 HTML, XML 및 텍스트의 세 가지 렌더링 함수 모드가 있습니다.

[렌더링 함수](../../interaction/using/creating-offer-spaces.md)에 대해 자세히 알아보세요.
+++
...
[스키마](../../configuration/using/about-schema-reference.md)에 대해 자세히 알아보세요.
+++
...
[스키마 확장](../../configuration/using/extending-a-schema.md)에 대해 자세히 알아보세요.
+++
...
[시드 주소](../../delivery/using/about-seed-addresses.md)에 대해 자세히 알아보세요.
+++
...
[서비스](../../delivery/using/about-services-and-subscriptions.md)에 대해 자세히 알아보세요.
+++
...
타깃팅 활동에 대한 자세한 내용은 [Campaign v8 설명서]&#x200B;(https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/targeting-activities)를 참조하세요.
.html){target="_blank"}.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/mrm/creating-and-managing-tasks.html?lang=ko){target="_blank"}에서 작업 활동에 대해 자세히 알아보세요.
+++
...
[Campaign v8의 추적 로그](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/tracking-logs){target="_blank"}에 대해 자세히 알아보세요.
+++
...
[트랜잭션 메시지](../../message-center/using/about-transactional-messaging.md)에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=ko){target="_blank"}에서 유형화에 대해 자세히 알아보세요.
+++
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=ko){target="_blank"}에서 유형화 규칙에 대해 자세히 알아보세요.
+++
...
[단일 모드](../../interaction/using/about-inbound-channels.md)에 대해 자세히 알아보세요.
+++
...
[웹 응용 프로그램](../../web/using/about-web-applications.md)에 대해 자세히 알아보세요.
+++

+++**워크플로**

워크플로우는 캠페인 실행 흐름을 시각적으로 표현한 것입니다. 애플리케이션 서버의 여러 모듈에 걸쳐 전체 프로세스 및 작업을 오케스트레이션할 수 있습니다. 이 포괄적인 그래픽 환경을 사용하면 세분화, 캠페인 실행, 파일 처리, 인원 참여 등의 프로세스를 디자인할 수 있습니다. 워크플로우 엔진은 이러한 프로세스를 실행하고 추적합니다.

[워크플로](../../workflow/using/about-workflows.md)에 대해 자세히 알아보세요.
+++
...
[작업 테이블](../../workflow/using/about-workflows.md)에 대해 자세히 알아보세요.
+++
