...
1. Azure Synapse Analytics은 TCP 1433 포트를 통해 통신하므로 방화벽에서 이 포트를 열어야 합니다. 다음 명령을 사용하십시오.
   ...
   >[!NOTE]
   >
   >Azure Synapse Analytics의 통신을 허용하려면 공개 IP를 허용 목록에 추가해야 할 수 있습니다. 이렇게 하려면 [Azure 설명서를 참조하십시오](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-firewall-configure#use-the-azure-portal-to-manage-server-level-ip-firewall-rules).
...
1. Campaign Classic에서 [!DNL Hadoop] 외부 계정을 구성합니다. 에서 **[!UICONTROL Explorer]**/ **[!UICONTROL Administration]** / **[!UICONTROL Platform]** /를 **[!UICONTROL External accounts]**&#x200B;클릭합니다.
...
1. Campaign Classic에서 [!DNL oracle] 외부 계정을 구성합니다. 에서 **[!UICONTROL Explorer]**/ **[!UICONTROL Administration]** / **[!UICONTROL Platform]** /를 **[!UICONTROL External accounts]**&#x200B;클릭합니다.
