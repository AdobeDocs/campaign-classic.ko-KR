...
로드된 기본 레코드 수를 변경하려면 목록의 오른쪽 아래 모서리에서 **[!UICONTROL Configure list]** 을 클릭합니다.

![](assets/s_ncs_user_configure_list.png)

목록 구성 창에서 **[!UICONTROL Advanced parameters]**(왼쪽 아래)을 클릭하고 검색할 라인의 수를 변경합니다.
...
1. 목록 오른쪽 및 아래의 **[!UICONTROL Configure list]** 을 클릭합니다.
...
1. 목록 구성 창에서 **[!UICONTROL Available fields]** 목록에 추가할 필드를 두 번 클릭하여 **[!UICONTROL Output columns]**&#x200B;에 추가합니다.
   ...
   >[!NOTE]
   >
   >기본적으로 고급 필드는 표시되지 않습니다. 이 필드를 표시하려면 사용 가능한 필드 목록 오른쪽 및 아래의 **고급 필드 표시**&#x200B;를 클릭하십시오.
   >
...
1. 필요한 경우 **[!UICONTROL Distribution of values]** 을 클릭하여 현재 폴더의 선택한 필드에 대한 값 재분할을 볼 수 있습니다.
...
목록 구성 창의 **[!UICONTROL Output columns]** 영역에서 마스킹할 열을 선택하고 삭제 단추를 클릭합니다.

![](assets/s_ncs_user_removecolumn_icon.png)

각 열의 마스킹에 대해 이 작업을 반복합니다. **[!UICONTROL OK]** 을 클릭하여 구성을 확인하고 결과를 표시합니다.
...
한 디스플레이 모드에서 다른 디스플레이 모드로 전환하려면 도구 모음에서 **[!UICONTROL Display sub-levels]** 를 클릭합니다.
...
1. **[!UICONTROL OK]** 을 클릭한 다음 **[!UICONTROL Save]** 를 클릭합니다.

그런 다음 이 구성을 다른 **배달** 폴더에 적용할 수 있습니다.

![](assets/s_ncs_user_folder_save_config_3.png)

폴더 속성 창에서 **[!UICONTROL Save]** 을 클릭합니다. 지정된 구성과 일치하도록 목록 표시가 수정되었습니다.

![](assets/s_ncs_user_folder_save_config_5.png)

## 목록 내보내기 {#exporting-a-list}

목록에서 데이터를 내보내려면 내보내기 마법사를 사용해야 합니다. 액세스하려면 목록에서 내보낼 요소를 선택하고 마우스 오른쪽 단추를 클릭한 다음 **[!UICONTROL Export...]** 을 선택합니다.

가져오기 및 내보내기 기능의 사용은 [일반 가져오기 및 내보내기](../../platform/using/about-generic-imports-exports.md)에 설명되어 있습니다.
