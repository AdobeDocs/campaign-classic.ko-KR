...
>
>인스턴스가 AWS에서 호스팅되는지 확인하려면 [이 섹션](https://docs.adobe.com/content/help/en/control-panel/using/faq.html#ims-org-id)에 자세히 나와 있는 단계를 따르십시오 .
...
아래 섹션에는 Adobe 호스팅 SFTP 서버와 연결 문제가 발생하는 경우 [지원 티켓을 통해](https://support.neolane.net) Adobe 지원 팀에 확인하고 제공하는 정보가 나와 있습니다.
...
1. SFTP 연결을 시작하려는 공개 IP가 허용 목록에 대해 Adobe 지원 서비스에 제공한 IP인지 확인하십시오.
