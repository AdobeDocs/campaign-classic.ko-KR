...
Explorer 탐색 트리를 사용자 지정할 수 있습니다. 구성 단계 및 모범 사례를 이 섹션[에서 &#x200B;](adobe-campaign-workspace.md)알아봅니다.
...
1. 창의 중간 섹션에 있는 쿼리 편집기에서 게재 필터 기준을 정의합니다. 그러면 정의된 필터에 해당하는 캠페인이 표시됩니다.
   ...
   >[!NOTE]
   >
   >쿼리 편집기가 [이 섹션](../../platform/using/adobe-campaign-workspace.md#about-queries-in-campaign)에 표시됩니다.
