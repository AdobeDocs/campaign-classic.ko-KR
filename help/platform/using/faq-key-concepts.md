...
자세한 내용은 [Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html#target-population){target="_blank"}를 참조하세요.
...
[Campaign v8 설명서](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/push/push.html){target="_blank"}에서 Adobe Campaign을 사용하여 개인화된 푸시 알림을 보내는 방법을 알아봅니다.
