...
1. **[!UICONTROL Delivery]** 유형 템플릿의 경우 컨트롤 그룹을 사용하여 측정을 수행할지 아니면 사용하지 않아야 할지를 지정합니다. [자세히 알아보기](#properties-of-a-hypothesis-template)
1. **[!UICONTROL Delivery]** 유형 템플릿의 경우 특정 채널을 선택하거나 **[!UICONTROL Channel]** 드롭다운 목록을 사용하여 Adobe Campaign에서 사용 가능한 모든 채널에 템플릿을 적용할 수 있습니다. [자세히 알아보기](#properties-of-a-hypothesis-template)
...
1. **[!UICONTROL Transactions]** 탭에서 가설 계산에 필요한 테이블 및 필드를 지정합니다. [자세히 알아보기](#transactions)
...
* **[!UICONTROL Measurement with control group]**: 컨트롤 그룹이 게재에 대해 정의되었는지 아니면 캠페인에 정의되어 있는지 여부를 나타내며 측정 지표에 포함할 수 있습니다. 게재를 받지 않는 제어 그룹은 게재를 받은 대상 모집단과 비교하여 게재 후의 캠페인 영향을 측정할 수 있도록 해줍니다.
   ...
   컨트롤 그룹 정의 및 구성에 대한 자세한 내용은 [이 섹션](../../campaign/using/marketing-campaign-deliveries.md#defining-a-control-group)을 참조하십시오.

* **[!UICONTROL Channel]**: 드롭다운 목록에서 을(를) 선택하여 Adobe Campaign 콘솔의 모든 채널에 대해 특정 채널을 선택하거나 가설 템플릿을 사용할 수  **[!UICONTROL All channels]** 있도록 할 수 있습니다. 특정 채널에 대한 템플릿을 구성하면 가설을 만들 때 채널당 게재를 자동으로 필터링할 수 있습니다. [자세히 알아보기](creating-hypotheses.md)
...
이 탭에는 거래의 관점에서 수신자 반응 내역을 저장할 수 있는 다양한 필드와 테이블이 포함되어 있습니다. 응답 관리 전용 테이블에 대한 자세한 내용은 이 [섹션](../../configuration/using/about-schema-reference.md)을 참조하십시오.
...
* **트랜잭션을 필터링합니다**. 탭 **[!UICONTROL Scope]** 에서 가설에 대한 필터를 구성할 수 있습니다. 방법은 다음과 같습니다.
