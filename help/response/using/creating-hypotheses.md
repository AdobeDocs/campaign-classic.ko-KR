...
1. 필요에 따라 [이 섹션](hypothesis-templates.md#creating-a-hypothesis-model)에 설명된 대로 하나 이상의 **[!UICONTROL Delivery]** 유형 템플릿을 만들 수 있습니다
...
가설 결과는 가설 **[!UICONTROL General]** 및 **[!UICONTROL Reactions]** 탭에서 볼 수 있습니다. [자세히 알아보기](hypothesis-tracking.md)
...
1. [이 섹션](hypothesis-templates.md#creating-a-hypothesis-model)에 설명된 대로 하나 이상의 **[!UICONTROL Offer]** 유형 모델을 만듭니다.
