...
Campaign SDK은 Campaign v7.4부터 [사용되지 않음](deprecated-features.md)됩니다. 기존 구현을 AEP Mobile SDK으로 원활하게 전환하기 위해 아래 <!--, using the associated [mobile SDK](../../delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)-->에 나열된 운영 체제에서 계속 사용할 수 있습니다.
