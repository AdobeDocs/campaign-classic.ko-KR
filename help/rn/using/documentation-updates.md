...
업데이트 날짜: **파일 전송** 활동 섹션에 미리 알림을 추가하여 SFTP 디렉토리에 있는 보관된 컨텐츠의 크기를 수동으로 모니터링합니다 **전송 후 소스 파일 삭제** 옵션이 선택되어 있지 않습니다. [자세히 표시](../../workflow/using/file-transfer.md#properties)

격리 및 차단 목록  섹션이 명확해졌습니다. [자세히 표시](../../delivery/using/understanding-quarantine-management.md#quarantine-vs-denylist)

주소를 격리하는 방법과 격리 목록에서 주소를 제거하는 방법에 대한 섹션이 업데이트되었습니다. [자세히 표시](../../delivery/using/understanding-quarantine-management.md#removing-a-quarantined-address)
