...
v7.4.1용 Linux 패키지 설치가 업데이트되었습니다. [자세히 알아보기](../../installation/using/installing-packages-with-linux.md)

### 2024년 6월 {#june-2024}

릴리스 정보 섹션에 7.4.1의 개선 사항, 호환성 업데이트, 패치 내역을 업데이트했습니다. [자세히 알아보기](latest-release.md)
...
Campaign 20.2.3 릴리스를 GA(General Availability)로 이동했습니다.
...
* [이메일에서 시드 및 증명을 관리하는 방법](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html?lang=ko#target-population){target="_blank"}.
