...
Campaign Classic 19.2를 시작하면 상태가 각 빌드에 연결됩니다. 상태, 상태, 의미 및 관련 이미지 목록 아래에 표시됩니다.

![](assets/green2.png)**일반**&#x200B;가용성:최신 안정적인 빌드를 사용할 수 있습니다.

![](assets/blue2.png)**릴리스**&#x200B;후보:Adobe에서 인증하여 제품 교정 작업을 기다리고 있습니다.

![](assets/orange2.png)**더**&#x200B;이상 사용할 수 없음:최신 빌드를 사용할 수 있습니다. 업데이트가 필요합니다.

![](assets/green3.png)**일반**&#x200B;가용성:최신 안정적인 빌드를 사용할 수 있습니다.

![](assets/blue3.png)**릴리스**&#x200B;후보:Adobe에서 인증하여 제품 교정 작업을 기다리고 있습니다.

![](assets/orange3.png)**더**&#x200B;이상 사용할 수 없음:최신 빌드를 사용할 수 있습니다. 업데이트가 필요합니다.
...
<table> 
 <tbody> 
  <tr> 
   ...
   <td>일반 가용성</td>
   <td>최신 안정적인 빌드를 사용할 수 있습니다.</td>
  </tr> 
   <tr> 
   <td><img src="assets/blue.png"/></td> 
   <td>릴리스 후보</td>
   <td>이 빌드는 Adobe에서 인증했습니다.  프로덕션 확인 대기 중입니다.</td>
  </tr> 
  <tr> 
   <td><img src="assets/orange.png"/></td> 
   <td>더 이상 사용할 수 없음</td>
   <td>이 빌드는 주요 문제가 없지만 추가 버그 수정을 통해 새로운 빌드를 사용할 수 있습니다. 업데이트가 필요합니다.</td>
  </tr> 
 </tbody> 
</table>
...
<tr>
  <td>
    ...
    <div>
    <img src="assets/green3.png"/><strong>일반 가용성</strong>
    </div>
    <p>
    <em>최신 안정적인 빌드를 사용할 수 있습니다.</em>
    <p>
  </td>
  <td>
    <img src="assets/available.png" />
    <div>
    <img src="assets/blue3.png"/><strong>릴리스 후보</strong>
    </div>
    <p>
    <em>이 빌드는 Adobe에서 인증했습니다. 프로덕션 확인 대기 중입니다.</em>
    <p>
  </td>
   <td>
    <img src="assets/update.png" />
    <div>
    <img src="assets/orange3.png"/><strong>더 이상 사용할 수 없음</strong>
    </div>
    <p>
    <em>이 빌드는 주요 문제가 없지만 추가 버그 수정을 통해 새로운 빌드를 사용할 수 있습니다. 업데이트가 필요합니다.</em>
    <p>
  </td>
</tr>
</table>
...
| 추가 리소스: |  |
|--- |--- |
| [최신 빌드로 업그레이드](https://helpx.adobe.com/campaign/kb/acc-build-upgrade.html) | [제어판 릴리스 정보](https://docs.adobe.com/content/help/en/control-panel/using/release-notes.html) |
| [최신 설명서 업데이트](../../rn/using/documentation-updates.md) | [이전 릴리스 노트](../../rn/using/release--19-1.md) |
...
<table> 
 <thead> 
  <tr> 
   <th> CPA(California Consumer Privacy Act)<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
...
<table> 
 <thead> 
  <tr> 
   <th> AMP를 사용한 인터랙티브한 컨텐츠 제작<br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
