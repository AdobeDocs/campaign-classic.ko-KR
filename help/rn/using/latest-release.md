...
>[!CAUTION]
>캠페인 **[!UICONTROL Help > About...]** 메뉴를 통해 [버전 및 빌드 번호](../../platform/using/launching-adobe-campaign.md#getting-your-campaign-version). 그러나 이 페이지에 나열된 9277~9343 사이의 모든 빌드에 대해 버전 번호는 7.1 대신 7.0을 보여줍니다.
