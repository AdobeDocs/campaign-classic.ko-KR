...
<table> 
 <tbody>
  ...
  <tr>  
   <td>팩스 채널<br></td>
   <td><p>Campaign 21.1.3 릴리스부터 팩스 채널을 더 이상 사용할 수 없습니다. <a href="https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html" target="_blank">Campaign v8 설명서에서 자세히 알아보기</a></p>
  </tr>
  <tr>
  <td>Demdex 도메인<br></td>
