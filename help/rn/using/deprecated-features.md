...
Netsize SMPP 커넥터는 더 이상 사용되지 않으며 2027년 1월에 제거됩니다. 이 날짜 이전에 **[!UICONTROL Extended generic SMPP]** 커넥터로 마이그레이션하는 것이 좋습니다. 자세한 정보는 [이 페이지](../../delivery/using/unsupported-connector-migration.md)를 참조하십시오.
