...
+ 릴리스 정보 {#release-notes}
  ...
  + {hide-from-toc}[설명서 업데이트 - 숨김](rn/using/documentation-updates.md)
+ 시작 {#getting-started}
  ...
  + {hide-from-toc}[용어집 - 숨김](platform/using/ac-glossary.md)
  + 개인 정보 {#privacy}
  ...
  + 프로필 관리 {#profile-management}
    ...
    + {hide-from-toc}[프로필 편집 - 숨김](platform/using/editing-a-profile.md)
    + {hide-from-toc}[프로필 추가 - 숨김](platform/using/adding-profiles.md)
    + {hide-from-toc}[프로필 관리 - 숨김](platform/using/managing-profiles.md)
    + [데이터 업데이트](platform/using/updating-data.md)
    + {hide-from-toc}[프로필 가져오기 및 내보내기 - 숨김](platform/using/exporting-and-importing-profiles.md)
  ...
  + 권한 {#permissions}
    ...
    + {hide-from-toc}[폴더 액세스 관리 - 숨김](platform/using/access-management-folders.md)
  + CRM 커넥터 {#connectors}
...
+ 메시지 만들기 및 보내기 {#sending-messages}
  ...
  + {hide-from-toc}[게재 설정 - 숨김](delivery/using/delivery-settings.md)
  + 빠른 시작 {#key-steps-when-creating-a-delivery}
    + {hide-from-toc}[게재 시작 - 숨김](delivery/using/steps-about-delivery-creation-steps.md)
    + {hide-from-toc}[게재 만들기 및 식별 - 숨김](delivery/using/steps-create-and-identify-the-delivery.md)
    + {hide-from-toc}[대상자 정의 - 숨김](delivery/using/steps-defining-the-target-population.md)
    + {hide-from-toc}[게재 유효성 검사 - 숨김](delivery/using/steps-validating-the-delivery.md)
    + {hide-from-toc}[게재 보내기 - 숨김](delivery/using/steps-sending-the-delivery.md)
    + {hide-from-toc}[게재 모범 사례 - 숨김](delivery/using/delivery-best-practices.md)
  ...
  + 게재 템플릿 사용 {#using-delivery-templates}
    ...
    + {hide-from-toc}[게재 템플릿 만들기 - 숨김](delivery/using/creating-a-delivery-template.md)
    + {hide-from-toc}[대상 매핑 선택 - 숨김](delivery/using/selecting-a-target-mapping.md)
    + {hide-from-toc}[템플릿에서 게재 만들기 - 숨김](delivery/using/creating-a-delivery-from-a-template.md)
  + 게재 개인화 {#personalizing-deliveries}
    + [개인화 정보](delivery/using/about-personalization.md)
    + {hide-from-toc}[개인화 필드 - 숨김](delivery/using/personalization-fields.md)
    + {hide-from-toc}[개인화 블록 - 숨김](delivery/using/personalization-blocks.md)
...
+ 마케팅 캠페인 오케스트레이션 {#orchestrating-campaigns}
  + {hide-from-toc}[캠페인 최적화 정보 - 숨김](campaign-opt/using/about-campaign-optimization.md)
  + 마케팅 캠페인 정보 {#about-marketing-campaigns}
    + {hide-from-toc}[마케팅 캠페인 디자인 - 숨김](campaign/using/designing-marketing-campaigns.md)
    + {hide-from-toc}[마케팅 캠페인 액세스 - 숨김](campaign/using/accessing-marketing-campaigns.md)
  + 캠페인 오케스트레이션 {#orchestrate-campaigns}
    + {hide-from-toc}[마케팅 캠페인 시작 - 숨김](campaign/using/setting-up-marketing-campaigns.md)
    + {hide-from-toc}[템플릿 만들기 및 구성 - 숨김](campaign/using/marketing-campaign-templates.md)
    + {hide-from-toc}[게재 추가 - 숨김](campaign/using/marketing-campaign-deliveries.md)
    + {hide-from-toc}[대상자 선택 - 숨김](campaign/using/marketing-campaign-target.md)
  ...
  + 캠페인 최적화 {#campaign-optimization}
    ...
    + {hide-from-toc}[규칙 적용 - 숨김](campaign-opt/using/applying-rules.md)
    + {hide-from-toc}[캠페인 시뮬레이션 - 숨김](campaign-opt/using/campaign-simulations.md)
+ 마케팅 리소스 관리 {#mrm}
...
+ 분산 마케팅 {#distributed-marketing}
  + {hide-from-toc}[분산 마케팅 정보 - 숨김](distributed/using/about-distributed-marketing.md)
  + {hide-from-toc}[로컬 캠페인 만들기 - 숨김](distributed/using/creating-a-local-campaign.md)
  + {hide-from-toc}[공동 작업 캠페인 만들기 - 숨김](distributed/using/creating-a-collaborative-campaign.md)
  + {hide-from-toc}[캠페인 패키지 게시 - 숨김](distributed/using/publishing-the-campaign-package.md)
  + {hide-from-toc}[캠페인 액세스 - 숨김](distributed/using/accessing-campaigns.md)
  + {hide-from-toc}[캠페인 추적 - 숨김](distributed/using/tracking-a-campaign.md)
  + {hide-from-toc}[사용 사례 - 숨김](distributed/using/examples.md)
...
+ 워크플로로 자동화 {#automating-with-workflows}
  ...
  + 타겟팅 활동 {#targeting-activities}
    ...
    + {hide-from-toc}[오퍼 엔진 - 숨김](workflow/using/offer-engine.md)
    + {hide-from-toc}[중복 제거 - 숨김](workflow/using/deduplication.md)
    + {hide-from-toc}[차원 변경 - 숨김](workflow/using/change-dimension.md)
    + {hide-from-toc}[목록 업데이트 - 숨김](workflow/using/list-update.md)
  ...
  + 작업 활동 {#action-activities}
    ...
    + {hide-from-toc}[SQL 데이터 관리 - 숨김](workflow/using/sql-data-management.md)
    + {hide-from-toc}[Nlserver 모듈 - 숨김](workflow/using/nlserver-module.md)
    + {hide-from-toc}[집계 업데이트 - 숨김](workflow/using/update-aggregate.md)
  + 이벤트 활동 {#event-activities}
    + {hide-from-toc}[이벤트 활동 정보 - 숨김](workflow/using/about-event-activities.md)
  ...
  + 데이터 관리 {#data-management}
    ...
    + {hide-from-toc}[데이터 보강 - 숨김](workflow/using/enriching-data.md)
    + {hide-from-toc}[집계 사용 - 숨김](workflow/using/using-aggregates.md)
    + {hide-from-toc}[중복 제거 활동의 병합 기능 사용 - 숨김](workflow/using/deduplication-merge.md)
    + {hide-from-toc}[반복 가져오기 워크플로 설정 - 숨김](workflow/using/recurring-import-workflow.md)
...
+ 설치 및 구성 안내서 {#installing-campaign-classic}
  ...
  + 부록 {#appendices}
    ...
    + {hide-from-toc}[Campaign 제거](installation/using/uninstalling-campaign.md)
...
+ 개발자 안내서 {#configuring-campaign-classic}
  ...
  + 스키마 작업 {#schema-reference}
    ...
    + 요소 및 속성 {#elements-attributes}
      ...
      + [조인](configuration/using/schema/join.md)
...
+ 마이그레이션 안내서 {#migrating-to-a-new-version}
  + {hide-from-toc}[Adobe Campaign v7로 마이그레이션](migration/using/about-migration.md)
  + 마이그레이션 절차 {#migration-procedure}
    + {hide-from-toc}[필수 구성 요소](migration/using/before-starting-migration.md)
    + {hide-from-toc}[마이그레이션 테스트 정보](migration/using/testing-the-migration.md)
    + {hide-from-toc}[구성 조정](migration/using/configuring-your-platform.md)
