...
user-guide-title: Campaign Classic v7 안내서
...
+ 릴리스 정보 {#release-notes}
   ...
   + 이전 릴리스 {#previous-releases}
      ...
      + [2022 - 숨김](rn/using/release-2022.md)
      + [2021 - 숨김](rn/using/release-2021.md)
   ...
   + [설명서 업데이트 - 숨김](rn/using/documentation-updates.md)
+ 시작 {#getting-started}
   ...
   + [Campaign 탐색기 사용 - 숨김](platform/using/adobe-campaign-explorer.md)
   + [목록 찾아보기 및 사용자 정의 - 숨김](platform/using/adobe-campaign-ui-lists.md)
   + [열거형 - 숨김](platform/using/managing-enumerations.md)
   ...
   + [용어집 - 숨김](platform/using/ac-glossary.md)
   + 개인 정보 {#privacy}
   ...
   + 프로필 관리 {#profile-management}
      ...
      + [프로필 편집 - 숨김](platform/using/editing-a-profile.md)
      + [프로필 추가 - 숨김](platform/using/adding-profiles.md)
      + [프로필 관리 - 숨김](platform/using/managing-profiles.md)
      + [데이터 업데이트](platform/using/updating-data.md)
      + [프로필 가져오기 및 내보내기 - 숨김](platform/using/exporting-and-importing-profiles.md)
   ...
   + 데이터 필터링 {#filtering-data}
      + [필터링 옵션 - 숨김](platform/using/filtering-options.md)
      + [필터 만들기 - 숨김](platform/using/creating-filters.md)
      + [사용 사례 - 숨김](platform/using/use-case.md)
   + [쿼리를 만드는 단계 - 숨김](platform/using/steps-to-create-a-query.md)
   + [필터 조건 정의 - 숨김](platform/using/defining-filter-conditions.md)
   + 권한 {#permissions}
      ...
      + [폴더 액세스 관리 - 숨김](platform/using/access-management-folders.md)
   + CRM 커넥터 {#connectors}
   ...
   + [도움말 및 지원 옵션 - 숨김](support.md)
+ 메시지 만들기 및 보내기 {#sending-messages}
   + [메시지 시작](delivery/using/communication-channels.md)
   + [게재 설정 - 숨김](delivery/using/delivery-settings.md)
   + 빠른 시작 {#key-steps-when-creating-a-delivery}
      + [게재 시작 - 숨김](delivery/using/steps-about-delivery-creation-steps.md)
      + [게재 만들기 및 식별 - 숨김](delivery/using/steps-create-and-identify-the-delivery.md)
      + [대상자 정의 - 숨김](delivery/using/steps-defining-the-target-population.md)
      + [게재 유효성 검사 - 숨김](delivery/using/steps-validating-the-delivery.md)
      + [게재 보내기 - 숨김](delivery/using/steps-sending-the-delivery.md)
      + [게재 모범 사례 - 숨김](delivery/using/delivery-best-practices.md)
   ...
   + 이메일 보내기 {#sending-emails}
      ...
      + 이메일 게재 보내기 {#sending-an-email}
         ...
         + [일본어 모바일에서 보내기 - 숨김](delivery/using/sending-emails-on-japanese-mobiles.md)
      + [파일 첨부 - 숨김](delivery/using/attaching-files.md)
   ...
   + 푸시 알림 보내기 {#sending-push-notifications}
      ...
      + [문제 해결 - 숨김](delivery/using/troubleshooting.md)
   + [다이렉트 메일 보내기](delivery/using/about-direct-mail-channel.md)
   + 다이렉트 메일 보내기 {#sending-direct-mail}
      + [DM 게재 만들기 - 숨김](delivery/using/creating-a-direct-mail-delivery.md)
      + [DM 콘텐츠 정의 - 숨김](delivery/using/defining-the-direct-mail-content.md)
      + [유효성 검사 - 숨김](delivery/using/validating.md)
   + 게재 템플릿 사용 {#using-delivery-templates}
      + [게재 템플릿 작업 - 숨김](delivery/using/about-templates.md)
      + [게재 템플릿 만들기 - 숨김](delivery/using/creating-a-delivery-template.md)
      + [대상 매핑 선택 - 숨김](delivery/using/selecting-a-target-mapping.md)
   ...
   + 게재 모니터링 {#monitoring-deliveries}
      + [게재 성능 모니터링](delivery/using/about-delivery-monitoring.md)
      + [메시지 추적](delivery/using/about-message-tracking.md)
      + [게재 성능 및 문제 해결](delivery/using/delivery-performance-troubleshooting.md)
      + [게재 실패 및 격리 관리](delivery/using/delivery-failures-quarantine.md)
      + [고급: 게재 로그 사용자 지정](delivery/using/customize-delivery-logs.md)
...
+ 마케팅 캠페인 오케스트레이션 {#orchestrating-campaigns}
   ...
   + 캠페인 오케스트레이션 {#orchestrate-campaigns}
      + [마케팅 캠페인 시작 - 숨김](campaign/using/setting-up-marketing-campaigns.md)
...
+ 마케팅 리소스 관리 {#mrm}
   + [마케팅 리소스 관리 정보 - 숨김](mrm/using/about-marketing-resource-management.md)
   + [작업 만들기 및 관리 - 숨김](mrm/using/creating-and-managing-tasks.md)
   + [비용 제어 - 숨김](mrm/using/controlling-costs.md)
   + [마케팅 리소스 관리 - 숨김](mrm/using/managing-marketing-resources.md)
   + [토론 포럼 - 숨김](mrm/using/discussion-forums.md)
+ 분산 마케팅 {#distributed-marketing}
   + [분산 마케팅 정보 - 숨김](distributed/using/about-distributed-marketing.md)
   + [로컬 캠페인 만들기 - 숨김](distributed/using/creating-a-local-campaign.md)
   + [공동 작업 캠페인 만들기 - 숨김](distributed/using/creating-a-collaborative-campaign.md)
   + [캠페인 패키지 게시 - 숨김](distributed/using/publishing-the-campaign-package.md)
   + [캠페인 액세스 - 숨김](distributed/using/accessing-campaigns.md)
   + [캠페인 추적 - 숨김](distributed/using/tracking-a-campaign.md)
   + [사용 사례 - 숨김](distributed/using/examples.md)
+ 응답 매니저 {#response-manager}
...
+ 보고서 디자인 및 공유 {#reporting}
   + 보고 시작 {#reporting-in-adobe-campaign}
   ...
   + 게재 보고서{#reports-on-deliveries}
      + [게재 보고서 정보](reporting/using/reports-on-deliveries.md)
...
+ 워크플로로 자동화 {#automating-with-workflows}
   ...
   + 타겟팅 활동 {#targeting-activities}
      ...
      + [셀별 오퍼 - 숨김](workflow/using/offers-by-cell.md)
      + [게재 개요 - 숨김](workflow/using/delivery-outline.md)
      + [데이터 보강 - 숨김](workflow/using/enrichment.md)
      + [스키마 편집 - 숨김](workflow/using/edit-schema.md)
      + [오퍼 엔진 - 숨김](workflow/using/offer-engine.md)
      + [중복 제거 - 숨김](workflow/using/deduplication.md)
      + [차원 변경 - 숨김](workflow/using/change-dimension.md)
      + [목록 업데이트 - 숨김](workflow/using/list-update.md)
      + [구독 서비스 - 숨김](workflow/using/subscription-services.md)
      + [데이터 업데이트 - 숨김](workflow/using/update-data.md)
      + [CRM 커넥터 - 숨김](workflow/using/crm-connector.md)
      + [데이터 소스 변경 - 숨김](workflow/using/change-data-source.md)
   + 흐름 제어 활동 {#flow-control-activities}
      ...
      + [작업 - 숨김](workflow/using/task.md)
   + 작업 활동 {#action-activities}
      + [작업 활동 정보 - 숨김](workflow/using/about-action-activities.md)
      + [게재 - 숨김](workflow/using/delivery.md)
      + [게재 제어 - 숨김](workflow/using/delivery-control.md)
      + [연속 게재 - 숨김](workflow/using/continuous-delivery.md)
      ...
      + [SQL 데이터 관리 - 숨김](workflow/using/sql-data-management.md)
      + [Nlserver 모듈 - 숨김](workflow/using/nlserver-module.md)
      + [업데이트 집계 - 숨김](workflow/using/update-aggregate.md)
   + 이벤트 활동 {#event-activities}
      + [이벤트 활동 정보 - 숨김](workflow/using/about-event-activities.md)
      + [파일 수집기 - 숨김](workflow/using/file-collector.md)
      + [파일 전송 - 숨김](workflow/using/file-transfer.md)
      + [웹 다운로드 - 숨김](workflow/using/web-download.md)
   ...
   + 데이터 관리 {#data-management}
      ...
      + [요약 목록 만들기 - 숨김](workflow/using/creating-a-summary-list.md)
...
+ 오퍼 관리 {#managing-offers}
   ...
   + 오퍼 게재 {#delivering-an-offer}
      ...
      + [도우미를 통한 오퍼 통합](interaction/using/integrating-an-offer-via-the-wizard.md)
...
+ 트랜잭션 메시지 {#transactional-messaging}
   ...
   + [사용 사례](message-center/using/transactional-email-with-attachments.md)
...
+ 설치 및 구성 안내서 {#installing-campaign-classic}
   ...
   + Campaign 설치(On-Premise){#install-campaign-on-prem}
      ...
      + Campaign 배포(On-Premise) {#initial-configuration}
