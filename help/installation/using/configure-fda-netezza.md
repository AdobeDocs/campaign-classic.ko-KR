...
description: FDA에서 Netezza에 대한 액세스를 구성하는 방법 알아보기
...
외부 데이터베이스에 저장된 정보를 처리하려면 Campaign [FDA(Federated Data Access](../../installation/using/about-fda.md)) 옵션을 사용하십시오. Netezza에 대한 액세스를 구성하려면 아래 단계를 따르십시오.
...
1. Adobe Campaign 서버의 환경 변수를 지정합니다.
   ...
   * **NZ_ODBC_INI_PATH**: odbc.ini 파일의 위치입니다. Netezza에서도 odbc.ini 파일을 사용하려면 이 두 번째 변수가 필요합니다.
...
>
>스키마에 정의된 첫 번째 인덱스에서 **Organize on** 절을 사용합니다. 이 절은 Netezza에서 1~4개의 열로 제한되므로 이 인덱스는 4개 이상의 열을 포함할 수 없습니다.
