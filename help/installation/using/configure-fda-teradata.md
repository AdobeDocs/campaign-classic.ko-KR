...
오류 **ODB-240000 ODBC 오류: \[Microsoft\]\[ODBC 드라이버 관리자\] 데이터 원본 이름을 찾을 수 없으며 기본 드라이버가 지정되지 않았습니다.** 16.X 드라이버를 사용하는 경우 Windows에서 발생합니다. Adobe Campaign에서는 teradata가 odbcinst.ini에서 &#39;{teradata}&#39;(으)로 지정되어야 합니다.
