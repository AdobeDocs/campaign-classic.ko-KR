...
>
>Neolane **사용자** 에 연결된 **홈** 디렉토리도 에서 자동으로 **[!UICONTROL /usr/local/neolane]**&#x200B;생성됩니다. 디스크 공간(몇 GB)이 충분한지 **[!UICONTROL /usr/local]** 확인하십시오.
...
네트워크 보고서 실행에 필요한 &#39;bc&#39; 명령(자세한 내용은 [이 섹션](../../production/using/monitoring-processes.md#automatic-monitoring-via-adobe-campaign-scripts) 참조)은 모든 Linux 배포에서는 기본적으로 사용할 수 없습니다. 명령을 사용할 수 있는지 확인하려면 &#39;which bc&#39; 명령을 실행하십시오. 그렇지 않은 경우 설치해야 합니다.
...
## APT(Debian)에 기반한 배포 {#distribution-based-on-apt--debian-}
...
* 환경 변수
   ...
   환경 [변수를 참조하십시오](../../installation/using/installing-packages-with-linux.md#environment-variables).
...
이러한 명령을 사용하여 **config-default.xml** 및 **serverConf.xml** 구성 파일을 만들 수 있습니다. serverConf.xml에서 사용할 수 있는 모든 매개 변수가 이 **섹션에 나열되어 있습니다** [](../../installation/using/the-server-configuration-file.md).
