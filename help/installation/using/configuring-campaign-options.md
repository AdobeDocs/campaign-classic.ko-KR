...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 배달 가능성 인스턴스에서 검색된 마지막 broadLogMsg 날짜입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Delivery_LastBroadLogMsgSent</span> <br /> </td> 
   <td> 배달성 인스턴스로 보낸 마지막 broadLogMsg 날짜입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">DmRendering_cuid</span> <br /> </td> 
   <td> 배달 보고서 식별자입니다. 식별자를 얻으려면 지원 팀에 문의하십시오.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 한 번에 배달되도록 만들어진 BroadLogs 수입니다.<br /> </td> 
  </tr> 
  <tr> 
 ...
 <tr> 
  ...
  <tr> 
   ...
   <td> 사용자가 비워 둔 경우 인스턴스 수준에서 이메일 배달에 사용되는 기본 '오류' 이메일 주소입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 사용자가 비워 둔 경우 인스턴스 수준에서 이메일 배달에 사용되는 기본 '회신' 이메일 주소입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsEmail_ExpOrganization</span> <br /> </td> 
   <td> 고객의 일반 이름입니다. 받는 사람에게 표시되는 일부 경고 메시지에 사용됩니다.<br /> "귀사는 ******* 또는 계열사와 연락을 취했으므로 이 메시지를 수신하게 됩니다. ******로부터 더 이상 메시지를 받지 않습니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 사용자가 비워 둔 경우 인스턴스 수준에서 이메일 배달에 사용되는 기본 '회신' 이메일 레이블입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> SMS 메시지를 보낼 때의 재시도 횟수<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 브라우저에서 이미지를 가져올 수 있도록 게재에 사용된 이미지가 저장되는 서버를 정의할 수 있습니다.<br /> 빌드 버전 &lt;= 5098의 경우 인스턴스에 업로드된 이미지의 URL을 사용합니다.<br /> 빌드 버전 5098보다 큰 경우 게시의 공개 URL 또는 <span class="uicontrol">XtkFileRes_Public_URL</span> 옵션의 URL을 대신 사용합니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Mgt <a href="../../workflow/using/campaign.md">기술 워크플로우 실행을</a> 모니터링할 수 있습니다. 활성화되면(값 "1") 실행 정보가 워크플로우 감사 로그에 기록됩니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 내보낸 보고서의 오른쪽 상단에 표시되는 로고.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsServer_PausedWorkflowPeriod</span> <br /> </td> 
   <td> 일시 중지된 워크플로우를 확인하는 동안 대기할 일 수입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCampaign_Activate_Owner확인</span> <br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 'true'로 설정된 경우 배포 마법사를 통해 xtkOption 값을 업데이트하도록 권한이 있는 비관리 연산자입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkSecurity_Unsafe_DecryptString</span> <br /> </td> 
   <td> 1을 선택한 경우 이 옵션을 사용하면 암호 해독 문자열 기능을 사용하여 일부 암호를 해독할 수 있습니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkTraceDeleteLogin</span> <br /> </td> 
   <td> "1" 값을 입력하여 레코드를 삭제하기 전에 "수정자" 필드의 수정을 통해 감사 추적 정보가 있는 요소의 삭제를 추적합니다.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 실시간 이벤트의 평균 큐 시간에 대한 경고 임계값.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 대기 중인 실시간 이벤트 대기열에 대한 위기 조건 이전의 임계값.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 실시간 이벤트 처리량의 경고 임계값.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsMessageCenter_RoutingBatchSize</span> <br /> </td> 
   <td> 이벤트 라우팅에 대한 재그룹핑 크기<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>데이터베이스에서 브로드로그가 지워지는 지연을 정의할 수 있습니다.</p><p>인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_EventHitoPurgeDelay</span> <br /> </td> 
   <td><p> 이벤트 내역이 데이터베이스에서 지워지는 지연을 정의할 수 있습니다.</p><p>
   인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_EventPurgeDelay</span> <br /> </td> 
   <td><p> 데이터베이스에서 이벤트가 지워지는 지연을 정의할 수 있습니다.</p><p>인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_EventStatPurgeDelay</span> <br /> </td> 
   <td><p> 이벤트 통계가 데이터베이스에서 지워지는 지연을 정의할 수 있습니다.</p><p>인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_ProvisionPurgeDelay</span> <br /> </td> 
   <td><p> 데이터베이스에서 제안이 지워지는 지연을 정의할 수 있습니다.</p><p> 인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_QuarantineMailboxFull</span> <br /> </td> 
   <td> <p>차단기가 데이터베이스에서 지워지는 지연을 정의할 수 있습니다.</p><p> 인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_RepetedDeliveryPurgeDelay</span> <br /> </td> 
   <td> <p>데이터베이스에서 재생 배달이 지워지는 지연을 정의할 수 있습니다.</p><p> 인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_RejectPurgeDelay</span> <br /> </td> 
   <td> <p>데이터베이스에서 거부되는 지연을 정의할 수 있습니다.</p><p>인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_TrackingLogPurgeDelay</span> <br /> </td> 
   <td> <p>데이터베이스에서 추적 로그가 지워지는 지연을 정의할 수 있습니다.</p><p>인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_TrackingStatPurgeDelay</span> <br /> </td> 
   <td><p> 데이터베이스에서 추적 통계가 지워지는 지연을 정의할 수 있습니다.</p><p> 인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_VisitorPurgeDelay</span> <br /> </td> 
   <td> <p>데이터베이스에서 방문자가 지워지는 지연을 정의할 수 있습니다.</p><p> 인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsCleanup_WorkflowResultPurgeDelay</span> <br /> </td> 
   <td> <p>데이터베이스에서 워크플로우 결과가 지워지는 지연을 정의할 수 있습니다.</p><p> 인터페이스 내에서 지연이 수정되면 이 옵션이 자동으로 만들어집니다. 옵션 목록에서 값을 수정하는 경우 초 단위로 표현되어야 합니다.</p><br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Adobe Campaign 인스턴스의 표준 시간대입니다. 구성을 <a href="../../installation/using/time-zone-management.md#configuration" target="_blank">참조하십시오</a>.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 데이터베이스의 'datetime' 필드는 timezone 정보를 저장합니까?<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 자동으로 생성된 내부 이름에 접두어가 추가되었습니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 이 시간 이후에 생성된 자동 k="true"와 "pkSequence" 특성이 없는 모든 사용자 지정된 스키마는 자동 생성 시퀀스 "auto_ &lt;schemanspace&gt; &lt;schemaname&gt; _seq를 가져옵니다. 
   </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> NmsEmailError <span class="uicontrol">Stat 테이블 정리</span> 마지막 처리 날짜입니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> '+ [provision's schema] + "_" + extAccountSource.@executionInstanceId + [제안 스키마] + "_" + var.executionInstanceIdFilter<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsInteraction_LastProvisionSynchExec_</span> <br /> </td> 
   <td> '+ [ provision's schema] + "_" + extAccountSource.@executionInstanceId + "_" + extAccountTarget@executionInstanceId<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 비동기 제안 쓰기("0"을 비활성화하면, "1"을 활성화하면)를 활성화/비활성화합니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 대금 청구 보고서를 보낼 때 사용되는 고객 식별자입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 공용 웹 응용 프로그램 서버의 기본 URL.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 사용자를 인증하고 사용자에게 권한을 제공하는 데 LDAP 서버를 사용할 수 있도록 합니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkLdap_AppLogin</span> <br /> </td> 
   <td> 다양한 검색을 위해 서버에 접속하는 응용 프로그램 로그인.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 'other server(s)' 모드에서 웹 양식 무효화에 사용할 인스턴스의 암호입니다.<br /> </td> 
  </tr> 
  <tr> 
