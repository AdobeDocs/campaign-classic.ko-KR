...
>[!CAUTION]
>
>* 이 페이지에 나열되지 않은 옵션은 내부용이며 **수정해서는 안 됩니다**.
>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 게재 기능 인스턴스로 보낸 마지막 broadLogMsg의 날짜입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">DmRendering_cuid</span> <br /> </td> 
   <td> 게재 보고서 식별자. 식별자를 얻으려면 지원팀에 문의하십시오.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 게재를 청구 보고서의 주 수신자로 간주하기 위한 최소 수신자 수입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 배달 준비 중 broadLogs 삽입을 위한 배치 크기가 두 배로 증가하는 배치 기간 임계값(밀리초 수)입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsBroadcast_MidAnalyzeBatchSize</span> <br /> </td> 
   <td> 중간 소싱 게재를 분석할 때 게재 부분 크기를 그룹화합니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsBroadcast_MsgValidityDuration</span> <br /> </td> 
   <td> 게재에 대한 기본 게재 기간(초)입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsBroadcast_RegexRules</span> <br /> </td> 
   <td> 게재 메시지를 정규화하기 위한 정규식입니다.<br /> </td> 
  </tr> 
  <tr> 
 ...
 <tr> 
   ...
   <td> 개인화된 URL에서 다운로드되고 이메일에 첨부된 이미지에 허용되는 최대 크기(바이트)를 정의할 수 있습니다. 기본값은 100,000바이트(100KB)입니다. 증명을 보내고 전자 메일을 처리하기 위해 이미지를 다운로드할 때 이미지 크기가 이 값을 초과하거나 다운로드 문제가 있는 경우 게재 로그에 오류가 표시되고 증명 배달이 실패합니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 푸시 메시지에 broadLogMsg 개수를 사용하지 않도록 설정합니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsDeliveryWizard_ShowDeliveryWeight</span> <br /> </td> 
   <td> 게재 도우미에 메시지 가중치를 표시합니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 사용자가 비워 두면 이메일 게재에 사용되는 인스턴스 수준의 기본 '회신' 이메일 주소입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 사용자가 비워 두면 이메일 게재에 사용되는 인스턴스 수준의 기본 '보낸 사람' 이메일 레이블입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsEmail_ReplyToName</span> <br /> </td> 
   <td> 사용자가 비워 두면 이메일 게재에 사용되는 인스턴스 수준의 기본 '회신' 이메일 레이블입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsEmail_RetryCount</span> <br /> </td> 
   <td> 전자 메일 메시지를 두 번 다시 시도하는 간격(초)입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsEmail_RetryPeriod</span> <br /> </td> 
   <td> 전자 메일 메시지를 다시 시도하는 기간입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsForecast_MsgWeightFormula</span> <br /> </td> 
   <td> 임시 게재용 메시지의 가중치를 계산하는 데 사용되는 수식입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> URL(LINE 채널)을 인코딩하기 위해 'lineImage' 서블릿에 사용된 AES 키입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_EmailMaxError</span> <br /> </td> 
   <td> 채널 "전자 메일"(기본값으로 사용) : 받는 사람을 격리하기 전에 보내는 동안 SOFT 오류에 대해 허용되는 최대 오류 수입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_EmailSignificantErrorDelay</span> <br /> </td> 
   <td> 채널 "전자 메일"(기본값으로 사용) : 새로운 SOFT 오류를 고려하기 전에 이전에 참조된 SOFT 오류 이후 소요된 최소 기간입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 채널 "모바일"에서 : 새로운 SOFT 오류를 고려하기 전에 이전에 참조된 SOFT 오류 이후 소요된 최소 기간입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> MidSourcing 세션에서 동시에 실행할 수 있는 최대 호출 수(기본적으로 3개).<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsMTA_Alert_Delay</span> <br /> </td> 
   <td> 사용자 지정 지연(분 단위). 이후 게재는 '지연됨'으로 간주되며 기본값은 30분입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsOperation_DeliveryPreparationWindow</span> <br /> </td> 
   <td><p>실행 중인 게재 수를 계산할 때 <span class="uicontrol"><a href="../../workflow/using/about-technical-workflows.md">operationMgt</a></span> 기술 워크플로우에서 이 옵션을 사용합니다.</p>상태가 일관되지 않은 게재가 실행 중인 게재 수에서 제외되는 일 수를 정의할 수 있습니다.</p><p>기본적으로 값은 "7"로 설정되어 있습니다. 즉, 7일이 지난 일관되지 않은 게재는 제외됩니다.</p></td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td> 보낸 SMS 메시지의 매개 변수: 메시지 우선 순위를 표시하기 위해 SMS 게이트웨이에 전송된 정보입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> SMS 메시지를 다시 시도하는 기간입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Code128.<br />에 대한 특수 문자 지원을 활성화/비활성화합니다. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 게재의 XML 코드 편집을 비활성화하려면 "0" 값과 함께 이 옵션을 추가하십시오(마우스 오른쪽 단추 클릭 / <span class="uicontrol">XML 소스 편집</span> 또는 <span class="uicontrol">CTRL + F4</span> 바로 가기).<br /> </td> 
  </tr>  
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> Adobe Campaign 클라이언트 콘솔에 게시할 리소스 위치입니다. <a href="../../delivery/using/formatting.md#image-referencing">이 섹션</a>.<br />을 참조하세요. </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NcmResourcesDirPreview</span> <br /> </td> 
   <td> Adobe Campaign 클라이언트 콘솔에서 미리 볼 수 있는 리소스의 위치입니다. <a href="../../delivery/using/formatting.md#image-referencing">이 섹션</a>.<br />을 참조하세요. </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsDelivery_DefaultIgnoredImage</span> <br /> </td> 
   <td> 업로드하는 동안 건너뛴 이미지의 URL 마스크 목록입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 이미지를 업로드할 인스턴스 이름을 구성할 수 있습니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 이미지 업로드를 위해 미디어 URL을 구성할 수 있습니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 이 개월 수에 대한 마케팅 기록이 표시됩니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 예약된 모드에서 대상 지정 및 추출 조건에 대한 기간입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 내보낸 보고서의 오른쪽 위 모서리에 표시할 로고입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 값으로 "1"을 입력하여 작업 소유자별 게재 유효성 검사를 활성화합니다. 이 옵션을 비활성화하려면 "0".<br />을(를) 입력하십시오. </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> (21.1.3 릴리스부터) 1을 선택하면(기본값) 이 옵션은 빌트인 JavaScript 코드 편집을 비활성화합니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkAcceptOldPassword</span> <br /> </td> 
   <td> (설치 호환성 모드: build&gt;6000) 활성화된 경우(값 "1") 이 옵션을 사용하면 데이터베이스에 저장된 이전 암호를 사용하여 외부 계정 또는 인스턴스에 연결할 수 있습니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 1을 선택한 경우 JavaScript에서 privilegeEscalation을 허용하는 옵션입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkSecurity_Disable_ControlsOnFileDownload</span> <br /> </td> 
   <td> 1을 선택하면 이 옵션은 파일 다운로드 중에 fileDownload.jsp를 통해 ACL 컨트롤을 비활성화합니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 레코드를 삭제하기 전에 "수정자" 필드를 수정하여 mData에 감사 추적 정보가 있는 요소의 삭제를 추적하려면 "1" 값을 입력하십시오.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 이벤트 강화를 위해 개인화할 JavaScript 라이브러리. 다음 두 함수의 구현을 포함해야 합니다. <br /> 
    <ul> 
     <li> <p> <span class="uicontrol">enrichRtEvents(aiEventId);</span> : 데이터베이스의 이벤트를 강화하고 저장합니다. 여기서 <span class="uicontrol">aiEventId</span>은(는) 처리된 실시간 이벤트 테이블에 해당합니다.</p> </li> 
     <li> <p> <span class="uicontrol">enrichBatchEvents(aiEventId);</span> : 데이터베이스의 이벤트를 강화하고 저장합니다. 여기서 <span class="uicontrol">aiEventId</span>은(는) 처리된 일괄 처리 이벤트의 ID 테이블에 해당합니다.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">MC_LastUpdateFromBL</span> <br /> </td> 
   <td> 게재 로그를 통한 마지막 이벤트 상태 업데이트 날짜입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">MC_RoutingCustomJs</span> <br /> </td> 
   <td> 라우팅 이벤트에 대해 개인화할 JavaScript 라이브러리입니다. 다음 두 함수의 구현을 포함해야 합니다. <br /> 
    <ul> 
     <li> <p> <span class="uicontrol">dispatchRtEvent(iEventId);</span> : 실시간 이벤트를 처리하도록 선택한 트랜잭션 메시지의 내부 이름을 반환합니다(<span class="uicontrol">iEventId</span>은(는) 처리된 실시간 이벤트의 ID에 해당됨).</p> </li> 
     <li> <p> <span class="uicontrol">dispatchBatchEvent(iEventId);</span> : 일괄 처리 이벤트를 처리하기 위해 선택한 트랜잭션 메시지의 내부 이름을 반환합니다(<span class="uicontrol">iEventId</span>은(는) 처리된 일괄 처리 이벤트의 ID에 해당).</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 이벤트 라우팅에 대한 다시 그룹화의 크기입니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Azure SQL Datawarehouse 커넥터 옵션입니다.<br /> </td> 
  </tr>
   <tr> 
  ...
  <tr> 
   ...
   <td> Adobe Campaign 인스턴스의 시간대 <a href="../../installation/using/time-zone-management.md#configuration" target="_blank">구성</a>.<br />을 참조하세요. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 데이터베이스의 ID입니다. 유니코드 DataBase의 'u'부터 시작합니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 업그레이드 후 발생한 오류에 대한 정보입니다. 아래 구문:<br /> <strong>{Build number}:{mode: pre/post/...}:{오류가 발생한 'lessThan'/'greaterOrEquelThan' 위치 + 하위 단계}</strong> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkCleanup_NoStats</span> <br /> </td> 
   <td> 통계 업데이트가 정리 워크플로우를 통해 수행되지 않도록 "1" 값을 입력하십시오.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Experience Cloud 트리거를 구성할 수 있습니다. 데이터 유형은 "긴 텍스트"이며 JSON 형식이어야 합니다. <a class="anchorLink" href="https://helpx.adobe.com/campaign/kb/triggers-and-campaign.html#PipelineoptionNmsPipelineConfig" target="_blank">Adobe Campaign Classic에서 Experience Cloud 트리거를 사용하는 방법</a>.<br />을 참조하세요. </td> 
  </tr> 
  <tr> 
   ...
   <td> 이 옵션은 CRM 커넥터를 통해 서드파티 시스템에서 데이터를 가져올 때 사용됩니다. 옵션을 활성화하면 마지막 가져오기 이후 수정된 개체만 수집할 수 있습니다. 이 옵션은 아래와 같이 수동으로 만들고 채워야 합니다. 
    <ul> 
     ...
     <li> <p> <span class="uicontrol">값(필드)</span> : yyyy/MM/dd hh:mm:ss 형식의 마지막 가져오기 날짜입니다. </p> </li> 
    </ul><br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 비동기 제안 쓰기를 활성화/비활성화합니다(비활성화하려면 "0", 활성화하려면 "1").<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsModule_CouponsEnabled</span> <br /> </td> 
   <td> 쿠폰을 사용하도록 설정할 수 있습니다.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 응용 프로그램 서버에 액세스하기 위한 내부 기본 URL입니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 웹 추적 관리를 위해 디자인된 가상 게재의 이름입니다.<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 옵션 1을 선택한 경우 두 번째 단계에서 인터페이스에서 삭제를 수동으로 확인해야 합니다. 그렇지 않으면 확인 없이 데이터가 삭제됩니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Privacy_Request_ConfirmDeletePendingDelay</span> <br /> </td> 
   <td> 요청 사이의 지연은 삭제 확인을 기다리고 요청이 취소됩니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Privacy_Request_MaxErrorAllowed</span> <br /> </td> 
   <td> 개인 정보 요청을 처리/삭제할 때 허용되는 최대 오류 개수입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Privacy_Request_PurgeDelay</span> <br /> </td> 
   <td> 대기열에 요청이 만들어지고 요청 데이터가 삭제됩니다.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> LDAP 서버를 사용하여 사용자를 인증하고 사용자에게 권한을 제공할 수 있습니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkLdap_AppLogin</span> <br /> </td> 
   <td> 응용 프로그램 로그인으로 서버에 연결하여 다양한 검색을 수행합니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 로그인을 기반으로 한 LDAP DN에 대한 계산 수식입니다.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> LDAP 서버(일반, md5, lds, ntlm, dpa)에 연결하는 데 사용되는 인증 유형입니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkLdap_Rights</span> <br /> </td> 
   <td> LDAP 디렉터리의 권한 및 그룹을 Adobe Campaign의 명명된 권한으로 동기화할 수 있습니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkLdap_RightsAttr</span> <br /> </td> 
   <td> 인증 이름이 포함된 LDAP 특성입니다.<br /> </td> 
  </tr> 
  <tr> 
