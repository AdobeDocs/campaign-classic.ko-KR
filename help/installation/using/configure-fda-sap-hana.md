...
description: FDA에서 SAP HANA에 대한 액세스를 구성하는 방법 알아보기
...
외부 데이터베이스에 저장된 정보를 처리하려면 Campaign [FDA(Federated Data Access](../../installation/using/about-fda.md)) 옵션을 사용하십시오. SAP HANA에 대한 액세스를 구성하려면 아래 단계를 따르십시오.
