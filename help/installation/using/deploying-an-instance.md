...
바운스는 Adobe Campaign에 나열된 규칙을 적용하여 자동으로 처리됩니다 **관리 > 캠페인 관리 > 산출물이 아닌 관리 > 게재 로그 자격** 노드 아래에 있어야 합니다. 자세한 내용은 [반송 메일 관리](../../delivery/using/understanding-delivery-failures.md#bounce-mail-management).
