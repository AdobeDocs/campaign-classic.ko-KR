...
Adobe Campaign을 사용하면 날짜를 시간대의 함수로 표현할 수 있습니다. 이렇게 하면 국제 사용자가 다양한 시간대에서 전 세계에서 작업할 수 있습니다. 동일한 인스턴스를 사용하는 각 국가는 현지 시간에 따라 캠페인 실행, 추적, 보관 등을 관리할 수 있습니다.
...
>[!IMPORTANT]
>
>**Oracle**&#x200B;을(를) 사용하는 경우 Oracle 클라이언트 계층의 시간대 파일(.dat)은 서버에 설치된 시간대 파일과 호환되어야 합니다.
