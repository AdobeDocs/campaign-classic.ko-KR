...
product: campaign
title: Hadoop 액세스 구성
description: FDA에서 Hadoop에 대한 액세스를 구성하는 방법 알아보기
...
외부 데이터베이스에 저장된 정보를 처리하려면 Campaign **FDA(Federated Data Access**) 옵션을 사용하십시오. Hadoop에 대한 액세스를 구성하려면 아래 단계를 따르십시오.
...
1. DSN(Data Source Name)을 만들고 odbc.ini 파일을 편집합니다. 그런 다음 Hive 연결에 대한 DSN을 만듭니다.
   ...
   인증 설정은 Hive/Hadoop 구성에 따라 다릅니다. 예를 들어 HD Insight의 경우 [여기](https://www.simba.com/products/Spark/doc/ODBC_InstallGuide/unix/content/odbc/hi/configuring/authenticating/azuresvc.htm)에 설명된 대로 사용자/암호 인증에 AuthMech=6을 사용합니다.
