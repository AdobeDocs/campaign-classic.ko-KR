...
응용 프로그램이 Oracle에서 개발한 JDK(Java Development Kit)와 **OpenJDK**&#x200B;에 대해 승인되었습니다.
...
JDK를 다운로드하려면 [Oracle 웹 사이트](https://www.oracle.com/technetwork/java/javase/downloads/index.html){target="_blank"}에 연결하십시오.
