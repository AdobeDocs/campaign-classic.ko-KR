...
Campaign 인스턴스에서 워크플로 등 JavaScript 코드를 통해 호출할 수 있는 URL의 기본 목록은 Campaign Classic 인스턴스는 제한됩니다. 인스턴스는 이러한 URL이 있어야 정상 작동합니다.
...
* **허용**: Permissive에 속하지 않는 모든 URL은 허용됩니다.
...
>
>마이그레이션으로부터 온 기존 고객은 **경고** 모드를 일시적으로 사용할 수 있습니다. URL을 허용하기 전에 아웃바운드 트래픽을 분석합니다. 허용 URL 목록이 정의되면 URL 목록에 URL을 추가하고 **차단** 모드를 활성화할 수 있습니다.
