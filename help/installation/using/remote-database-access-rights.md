...
1. 다음 **[!UICONTROL Name]** 필드는 다음 형식을 사용해야 합니다. **사용자:base@server**, 위치 :
...
1. 이름이 지정된 사용자를 저장한 다음, **[!UICONTROL Administration > Access Management > Operators]** 노드 아래에 나열된 상태로 남아 있습니다.
