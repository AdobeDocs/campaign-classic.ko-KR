...
또한 인스턴스의 관리자는 **감사 추적**&#x200B;을 사용하여 작업 및 워크플로우에 대한 마지막 수정 작업, 작업 과정 상태를 확인할 수 있습니다. 자세한 내용은 [전용 섹션](../../production/using/audit-trail.md)을 참조하십시오.
...
워크플로우는 특정 활동을 통해 조작할 수 있는 작업표를 전달합니다. Adobe Campaign을 사용하면 데이터 관리 활동을 통해 워크플로우 워크플로우의 열을 수정, 이름 변경 및 보완할 수 있습니다. 예를 들어 클라이언트의 요구 사항에 따라 해당 열을 계약서에 대한 공동 수익자에 대한 추가 정보를 수집하기 위해 워크플로우 워크플로우에 맞게 열을 변경할 수 있습니다.
