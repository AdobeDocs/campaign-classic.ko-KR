...
![](assets/do-not-localize/how-to-video.png) 이 사용 사례는 비디오 형식에서도 찾을 수 있습니다. 자세한 내용은 [워크플로우 만들기](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/automating-with-workflows/creating-a-workflow.html) 비디오.

이렇게 하려면 캠페인을 만들고 **[!UICONTROL Targeting and workflows]** 탭. 자세한 내용은 [워크플로우에서 기본 타겟 작성](../../campaign/using/marketing-campaign-deliveries.md#building-the-main-target-in-a-workflow) 섹션을 참조하십시오.

그런 다음 다음 단계를 수행합니다.

## 전송 예약 {#configuring-the-scheduler}

1. 먼저 다음을 추가합니다 **스케줄러** 게재 전송을 매일 트리거합니다. 아래 예에서는 게재가 매일 오전 6시에 만들어집니다.
