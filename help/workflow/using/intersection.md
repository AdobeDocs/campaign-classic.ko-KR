...
1. 나머지 데이터를 사용하려면(쿼리와 관련되지만 교차 지점은 아님) **[!UICONTROL Generate complement]** 상자를 선택합니다.
...
이 세 값 집합은 교차로 결과 대상을 식별합니다. **[!UICONTROL tableName]** 는 대상 식별자를 기록하는 테이블의 이름 **[!UICONTROL schema]** 이며 모집단의 스키마(일반적으로  **[!UICONTROL nms:recipient]**)이며  **[!UICONTROL recCount]** 는 테이블의 요소 수입니다.
