...
1. 데이터 배포 모델을 사용하는 **[!UICONTROL Split]** 유형 활동으로 인해 타겟팅으로 인한 모집단을 제한할 수 있습니다.

   ![](assets/local_validation_intro_1.png)

1. 그런 다음 **[!UICONTROL Local approval]** 활동을 통해 각 로컬 감독자에게 알림 이메일을 보냅니다. 활동은 각 지역 관리자가 자신에게 할당된 수신자를 승인할 때까지 보류됩니다.

   ![](assets/local_validation_intro_4.png)

1. 승인 기한이 되면 워크플로우가 다시 시작됩니다. 이 예에서는 **[!UICONTROL Delivery]** 활동이 시작되고 게재가 승인된 타겟으로 전송됩니다.
...
1. 며칠 후 두 번째 **[!UICONTROL Local approval]** 유형 활동은 연락처가 수행하는 작업(클릭, 열기 등)에 대한 요약을 포함하는 각 로컬 상위자에게 알림 이메일을 보냅니다.
...
1. 승인할 수신자 목록에서 모든 수신자를 미리 선택하도록 **[!UICONTROL Approve the targeted messages]** 옵션을 선택된 상태로 두십시오.
1. **[!UICONTROL Delivery label]** 필드에서 기본 표현식(게재의 계산 문자열)을 남겼습니다. 게재의 표준 레이블은 피드백 알림에 사용됩니다.
1. **[!UICONTROL Grouping field]** 섹션에서 승인 및 피드백 알림에 수신자를 표시하기 위한 그룹화 필드로 **[!UICONTROL Gender]** 필드를 선택했습니다.
1. **[!UICONTROL Edit targeted messages]** 섹션에서 **[!UICONTROL Edit recipients]** 웹 애플리케이션과 **[!UICONTROL recipientId]** 매개 변수를 선택했습니다. 승인 및 피드백 알림에서 수신자는 클릭 가능하고 웹 애플리케이션의 URL을 가리킵니다. 추가 URL 매개 변수는 **[!UICONTROL recipientId]**&#x200B;입니다.
...
1. **[!UICONTROL Keep only the first records after sorting]** 옵션을 선택하고 **[!UICONTROL Next]** 를 클릭합니다.
...
두 번째 **[!UICONTROL Local approval]** 활동을 사용하면 각 로컬 감독자에게 게재 피드백 알림을 보낼 수 있습니다.
...
1. **[!UICONTROL Notification]** 섹션에서 게재 템플릿과 알림 이메일에 사용할 제목을 선택합니다.

대기 활동에 구성된 최종 기한에 도달하면 두 번째 **[!UICONTROL Local approval]** 유형 활동은 각 로컬 감독자에게 다음 알림 이메일을 보냅니다.
...
캠페인의 타겟팅 워크플로우로 이동하고 **[!UICONTROL Local approval tasks]** 탭을 클릭합니다.
...
모니터링할 작업을 선택하고 **[!UICONTROL Detail]** 버튼을 클릭합니다. 로컬 승인 작업의 **[!UICONTROL General]** 탭에서는 작업에 대한 정보를 볼 수 있습니다. 필요한 경우 승인 및 미리 알림 날짜를 변경할 수 있습니다.
...
작업의 **[!UICONTROL Distribution]** 탭에서는 승인 로그, 상태, 타겟팅된 메시지 수, 승인 날짜 및 게재를 승인한 운영자를 볼 수 있습니다.

![](assets/local_validation_admin_4.png)

승인 로그를 선택하고 **[!UICONTROL Detail]** 버튼을 클릭하여 자세한 정보를 표시합니다. 로컬 승인 로그의 **[!UICONTROL General]** 탭에서는 일반 로그 정보를 볼 수 있습니다. 승인 상태를 변경할 수도 있습니다.
...
승인 로그의 **[!UICONTROL Targeted]** 탭에는 타겟팅된 수신자 목록과 승인 상태가 표시됩니다. 필요한 경우 이 상태를 변경할 수 있습니다.
