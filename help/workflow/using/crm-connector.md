...
Adobe Campaign의 CRM 커넥터에 대한 자세한 내용은 이 [섹션](../../platform/using/crm-connectors.md)을 참조하세요.
...
이 활동의 구성은 수행할 프로세스에 따라 다릅니다. 다양한 구성이 이 페이지의 [에 자세히 설명되어 있습니다](../../platform/using/crm-data-sync.md).
