...
>[!IMPORTANT]
>
>시퀀스는 32비트 정수 값으로, 사용 가능한 값의 수가 제한되어 있습니다.21억 4천. 최대 값에 도달한 후 ID를 재활용하기 위해 시퀀스가 0으로 돌아갑니다.
>
>이전 데이터를 제거하지 않은 경우, 그 결과는 고유한 키 위반이 되며, 이는 플랫폼 상태 및 사용에 대한 차단이 됩니다. Adobe Campaign은 통신(전달 로그 표에 영향을 줄 때)을 전송할 수 없으며 성능에 큰 영향을 줄 수 있습니다.
