...
웹 애플리케이션 덕분에 Social Marketing을 사용하면 Facebook 애플리케이션에 개인화된 콘텐츠를 표시할 수 있으므로 이 소셜 네트워크를 통해 잠재 고객을 더 쉽게 확보할 수 있습니다. facebook 유형 웹 애플리케이션의 자세한 예는 다음을 참조하십시오 [facebook 앱의 예](../../social/using/examples-of-facebook-apps.md).

>[!NOTE]
>
>또한 파트너가 개발한 Facebook 애플리케이션과 Adobe Campaign을 통합할 수 있습니다. 이 경우 Adobe Campaign 웹 애플리케이션을 사용하여 Facebook 프로필을 획득할 필요가 없습니다. 자세한 내용은 [외부 계정 구성](#configuring-external-accounts).
...
1. 을(를) 입력합니다. **[!UICONTROL terms of service]** 및 **[!UICONTROL Privacy policy]** facebook 권한 요청 화면에 표시되는 링크입니다. 자세한 내용은 다음을 참조하십시오. [서비스 약관 및 개인 정보 보호 정책 링크 입력](#entering-the-terms-of-service-and-privacy-policy-links).
1. 각 Facebook 응용 프로그램에 대해 **[!UICONTROL Facebook Connect]** 외부 계정을 입력합니다. 자세한 내용은 다음을 참조하십시오. [외부 계정 구성](#configuring-external-accounts).
1. 각 Facebook 애플리케이션에 대해 Adobe Campaign에서 Facebook 유형 웹 애플리케이션을 만듭니다. 자세한 내용은 다음을 참조하십시오. [facebook 유형 웹 애플리케이션 만들기](#creating-a-facebook-type-web-application).
...
* **Facebook**: 앞에서 만든 응용 프로그램 선택( [https://developers.facebook.com/apps](https://developers.facebook.com/apps))을 클릭하고 **[!UICONTROL Settings]** > **[!UICONTROL Basic]** 탭.
...
* **Adobe Campaign**: 로 이동 **[!UICONTROL Administration > Platform > External accounts]** 트리의 노드를 클릭하고 **[!UICONTROL New]**.
...
1. 응용 프로그램의 호스팅 모드를 선택합니다. **[!UICONTROL hosted by a partner]** 또는 **[!UICONTROL hosted by this instance]**.
   ...
   **이 인스턴스에 의해 호스팅되는 응용 프로그램**
   ...
   이 인스턴스에서 애플리케이션을 호스팅하려면(타사 애플리케이션이 없는 경우) Adobe Campaign 웹 애플리케이션을 사용하여 Facebook 프로필을 가져와야 합니다. 자세한 내용은 [facebook 앱의 예](../../social/using/examples-of-facebook-apps.md).
...
1. Adobe Campaign 콘솔에서 **[!UICONTROL Subscribe]** 버튼을 클릭하여 Adobe Campaign에서 팬이 이 애플리케이션을 통해 체크인할 때마다 데이터를 실시간으로 복구할 수 있습니다. 자세한 내용은 다음을 참조하십시오. [facebook 앱의 예](../../social/using/examples-of-facebook-apps.md).
...
1. 에서 **[!UICONTROL Application]** 필드에서 Facebook 애플리케이션에 연결된 외부 계정을 입력합니다. 자세한 내용은 다음을 참조하십시오. [외부 계정 구성](#configuring-external-accounts).

   ![](assets/social_webapp_005.png)

1. 을(를) 선택합니다 **[!UICONTROL Edit]** 탭을 클릭한 다음 웹 애플리케이션을 편집합니다. 자세한 내용은 다음을 참조하십시오. [facebook 앱의 예](../../social/using/examples-of-facebook-apps.md).
...
1. 에서 **[!UICONTROL Secure Page Tab URL]** 필드에서는 웹 응용 프로그램의 공개 URL을 입력하고, 이 URL은 **[!UICONTROL Dashboard]** 웹 응용 프로그램의 탭입니다. facebook 유형 웹 애플리케이션 만들기에 대한 자세한 내용은 [facebook 유형 웹 애플리케이션 만들기](#creating-a-facebook-type-web-application).
