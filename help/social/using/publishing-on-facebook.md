...
**[!UICONTROL Target of the proofs]** 탭에서는 발송하기 전에 게재를 테스트하는 데 사용할 Facebook 페이지를 정의할 수 있습니다. 이를 위해 전용 비공개 Facebook 페이지를 만드는 것이 좋습니다. 비공개 Facebook 페이지 만들기에 대한 자세한 내용은 [테스트 Facebook 페이지 만들기](../../social/using/publishing-on-facebook-walls.md#creating-a-test-facebook-page)를 참조하십시오. 증명 대상을 선택하려면 기본 대상과 동일한 단계를 적용합니다.[기본 대상 선택](#selecting-the-main-target)

![](assets/social_facebook_delivery_004.png)

>[!NOTE]
>
>모든 게재에 대해 동일한 Facebook 테스트 페이지를 사용하는 경우 **[!UICONTROL Resources > Templates > Delivery templates]** 노드를 통해 액세스하는 **[!UICONTROL Publish to a brand page]** 배달 템플릿에 증명 대상을 저장할 수 있습니다. 각 새 배달에 대해 기본적으로 증명 타겟이 입력됩니다.
...
하지만 Facebook에서 사용하는 대상 필터를 사용할 수도 있습니다. **[!UICONTROL Select target window]**&#x200B;의 **[!UICONTROL Audience]** 탭에는 다음 네 개의 필터가 있습니다.
...
1. **[!UICONTROL Status]** 필드에 페이지 이름 아래에 표시될 텍스트를 입력합니다.
...
1. **[!UICONTROL Link]** 필드에 발행물이 가리키는 URL을 입력합니다.
   ...
   >1. Adobe Campaign 콘솔을 통해 발행물의 **[!UICONTROL Link]** 필드로 이동하고 **[!UICONTROL Canvas page]** 필드의 URL을 입력합니다.
...
1. **[!UICONTROL Caption]** 필드에 발행물 끝에 나타날 텍스트를 입력합니다.
...
1. **[!UICONTROL Status]** 필드에 페이지 이름 아래에 표시될 텍스트를 입력합니다.
1. **[!UICONTROL Name]** 필드에 발행물 제목을 입력합니다.
1. **[!UICONTROL Video code]** 필드에 YouTube 비디오 코드를 입력합니다. 예를 들어 &#39;https://www.youtube.com/watch?v=abc123456&#39; 링크&#39;의 경우 비디오 코드는 &#39;abc123456&#39;입니다.
1. **[!UICONTROL Caption]** 필드에 발행물 끝에 나타날 텍스트를 입력합니다.
1. **[!UICONTROL Description]** 필드로 이동하여 제목 아래에 표시할 텍스트를 입력합니다.
...
>[!NOTE]
>
>미리 보기는 최종 Facebook 게시와 약간 다를 수 있습니다. 최종 전달에 앞서 발행물을 정확하게 렌더링하기 위해 증명 자료를 보내는 것이 좋습니다. [증명 전송](#sending-the-proof)을 참조하십시오.
...
비공개 Facebook 테스트 페이지에서 발행물의 정확한 렌더링을 보려면 최종 배달 전에 발행물 증명을 보내는 것이 좋습니다. 비공개 Facebook 테스트 페이지 만들기에 대한 자세한 내용은 [테스트 Facebook 페이지 만들기](../../social/using/publishing-on-facebook-walls.md#creating-a-test-facebook-page)를 참조하십시오. 대상 증명을 선택하는 단계는 [증명 대상 선택](#selecting-the-proof-target)에 자세히 설명되어 있습니다.
